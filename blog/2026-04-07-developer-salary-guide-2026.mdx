...
| Self-serve interactive platforms | **Low monthly subscription** (see [current pricing](/docs/pricing/), 20% off via our link) | Ongoing / self-paced | Lower cash risk; requires discipline and portfolio proof |
...
<PricingCTA
  ...
  subtitle="Scrimba Pro is a fraction of bootcamp cost, use it to build a portfolio employers can verify. Our link applies 20% off at checkout. We earn a commission if you upgrade through our links, at no extra cost to you."
