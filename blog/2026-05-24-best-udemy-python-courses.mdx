...
## 1. 100 Days of Code: The Complete Python Pro Bootcamp by Dr. Angela Yu {#1-100-days-of-code-the-complete-python-pro-bootcamp-by-dr-angela-yu}
...
## 2. The Complete Python Bootcamp From Zero to Hero in Python by Jose Portilla {#2-the-complete-python-bootcamp-from-zero-to-hero-in-python-by-jose-portilla}
...
## 3. Python for Data Science and Machine Learning Bootcamp by Jose Portilla {#3-python-for-data-science-and-machine-learning-bootcamp-by-jose-portilla}
