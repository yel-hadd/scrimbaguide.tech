...
## Can a JavaScript developer become an AI engineer without Python? {#can-a-javascript-developer-become-an-ai-engineer-without-python}
...
## What an AI engineer actually does (and why JavaScript covers most of it) {#what-an-ai-engineer-actually-does-and-why-javascript-covers-most-of-it}
...
## Why 2026 is the year the JavaScript AI stack caught up {#why-2026-is-the-year-the-javascript-ai-stack-caught-up}
...
## The 2026 AI engineer job market, in real numbers {#the-2026-ai-engineer-job-market-in-real-numbers}
...
## What you already know that transfers, and the three gaps to close {#what-you-already-know-that-transfers-and-the-three-gaps-to-close}
...
## Your JavaScript-first AI engineer roadmap, skill by skill {#your-javascript-first-ai-engineer-roadmap-skill-by-skill}
...
## When you actually do need Python (the honest line) {#when-you-actually-do-need-python-the-honest-line}
...
## The portfolio that gets a JavaScript AI engineer hired {#the-portfolio-that-gets-a-javascript-ai-engineer-hired}
...
## Self-assemble vs the structured version of what you just built by hand {#self-assemble-vs-the-structured-version-of-what-you-just-built-by-hand}
...
A structured path trades a low monthly subscription for that sequencing. Scrimba's AI Engineer Path runs about 11.4 hours, JavaScript and TypeScript throughout, with no PyTorch. It teaches you to wire LLMs, agents, RAG, and MCP into apps you already ship, in roughly the order this roadmap lists, which is the order a real project is built in. The free intro lessons let you test the edit-the-instructor's-code format before paying anything (current [Scrimba pricing](/docs/pricing/), and what is free, are spelled out there).
