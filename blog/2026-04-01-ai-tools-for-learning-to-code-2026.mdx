...
You can use **ChatGPT** beside Scrimba for questions, and still keep **Scrimba** as the place you **prove** you can implement. Many learners do exactly that. Scrimba's own [Explain](/blog/scrimba-explain-review/) covers part of the question side from inside the lesson, and because it only explains, it cannot slide into paste-the-homework mode.
