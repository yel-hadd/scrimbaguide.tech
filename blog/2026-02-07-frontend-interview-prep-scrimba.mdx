...
Combined, these courses give you comprehensive preparation for all four interview stages in under 5 hours of focused study. All three are Pro courses; if you are still building the fundamentals they test, the [Frontend Developer Path](/docs/paths/frontend-developer-path/) sequences them after the React modules, and [Scrimba pricing](/docs/pricing/) explains what Pro costs relative to a bootcamp.
