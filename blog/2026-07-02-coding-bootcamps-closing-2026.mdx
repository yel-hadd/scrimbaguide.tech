...
## Which coding bootcamps have closed or downsized (tracker, last verified 2026-06-29) {#which-coding-bootcamps-have-closed-or-downsized-tracker-last-verified-2026-06-29}
...
## Why coding bootcamps are closing {#why-coding-bootcamps-are-closing}
...
## Are coding bootcamps dying, or just consolidating? {#are-coding-bootcamps-dying-or-just-consolidating}
...
## The risk nobody prices in: paying upfront for a program that might close mid-cohort {#the-risk-nobody-prices-in-paying-upfront-for-a-program-that-might-close-mid-cohort}
...
## When a bootcamp still makes sense in 2026 {#when-a-bootcamp-still-makes-sense-in-2026}
...
## The lower-risk way to learn the same skills {#the-lower-risk-way-to-learn-the-same-skills}
...
## How to decide in 5 minutes {#how-to-decide-in-5-minutes}
