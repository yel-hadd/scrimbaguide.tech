...
## The short answer: cheapest in dollars is not cheapest in hours {#the-short-answer-cheapest-in-dollars-is-not-cheapest-in-hours}
...
## How I compared these (cost per outcome, not sticker price) {#how-i-compared-these-cost-per-outcome-not-sticker-price}
...
## The genuinely free routes (and what they cost you in time) {#the-genuinely-free-routes-and-what-they-cost-you-in-time}
...
## One-off paid courses: Udemy agentic bootcamps, cheap each, several needed {#one-off-paid-courses-udemy-agentic-bootcamps-cheap-each-several-needed}
...
## Certificate programs (IBM, Johns Hopkins): mind the subscription clock {#certificate-programs-ibm-johns-hopkins-mind-the-subscription-clock}
...
## Cohort bootcamps (Maven and similar): when four figures is the right call {#cohort-bootcamps-maven-and-similar-when-four-figures-is-the-right-call}
...
## The subscription route: one monthly fee for the whole stack and the app around it {#the-subscription-route-one-monthly-fee-for-the-whole-stack-and-the-app-around-it}
...
Scrimba has free courses you can start today, which is the right way to test whether the interactive, edit-the-instructor's-code format fits how you learn before you pay for anything. If it clicks and you want the sequenced path with projects and a deploy at the end, Scrimba Pro is a low monthly subscription (see current [Scrimba pricing](/docs/pricing/) for the exact figure).
...
## Side by side: the routes, priced by what you actually finish with {#side-by-side-the-routes-priced-by-what-you-actually-finish-with}
...
## Do you even need a course? The free-assembly tradeoff, honestly {#do-you-even-need-a-course-the-free-assembly-tradeoff-honestly}
...
## What to learn first: tool calling, then retrieval, then a standard for tool access {#what-to-learn-first-tool-calling-then-retrieval-then-a-standard-for-tool-access}
...
<PricingCTA
  title="The lowest-cost coherent AI path"
  subtitle="Scrimba covers agents, RAG, and MCP end to end in JavaScript. Start free before you commit."
  ctaType="free"
/>
