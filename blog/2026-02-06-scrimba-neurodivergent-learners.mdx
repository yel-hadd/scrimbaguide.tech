...
## Why Traditional Coding Education Falls Short {#why-traditional-coding-education-falls-short}
...
### ADHD-Specific Challenges {#adhd-specific-challenges}
...
### Autism-Specific Considerations {#autism-specific-considerations}
...
### Dyslexia Considerations {#dyslexia-considerations}
...
## How Scrimba's Format Helps {#how-scrimbas-format-helps}

### Constant Engagement (Anti-Zoning-Out) {#constant-engagement-anti-zoning-out}
...
### Bite-Sized Lessons (3-15 Minutes) {#bite-sized-lessons-3-15-minutes}
...
### Zero-Setup, Low Executive Function Demand {#zero-setup-low-executive-function-demand}
...
### Self-Paced Without Judgment {#self-paced-without-judgment}
...
### Visual + Auditory + Kinesthetic Together {#visual--auditory--kinesthetic-together}
...
## Practical Strategies for Neurodivergent Scrimba Users {#practical-strategies-for-neurodivergent-scrimba-users}

### For ADHD Learners {#for-adhd-learners}
...
### For Autistic Learners {#for-autistic-learners}
...
### For Dyslexic Learners {#for-dyslexic-learners}
...
## Accommodations You Don't Have to Ask For {#accommodations-you-dont-have-to-ask-for}
...
- [How Scrimba's Interactive Scrims Work](/docs/how-it-works/how-scrims-work/), understanding the format in detail
- [Building a Coding Habit](/blog/build-coding-habit-scrimba/), the Tiny Habits approach to consistent learning
- [Scrimba for Busy Professionals](/docs/for/busy-professionals/), self-paced strategies that overlap significantly
