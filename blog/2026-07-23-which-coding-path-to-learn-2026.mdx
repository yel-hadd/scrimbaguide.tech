...
## The 2026 job market changed what "which path" even means {#the-2026-job-market-changed-what-which-path-even-means}
...
## The four Scrimba paths at a glance (and what each one leads to) {#the-four-scrimba-paths-at-a-glance-and-what-each-one-leads-to}
...
## Frontend: still the best on-ramp, if you go deeper than tutorials {#frontend-still-the-best-on-ramp-if-you-go-deeper-than-tutorials}
...
## Fullstack: the pragmatic hedge for most career changers {#fullstack-the-pragmatic-hedge-for-most-career-changers}
...
## Backend and the TypeScript pay premium hiding in the data {#backend-and-the-typescript-pay-premium-hiding-in-the-data}
...
## AI engineer: the fastest-growing path, and who it's actually for {#ai-engineer-the-fastest-growing-path-and-who-its-actually-for}
...
## A decision framework: match the path to your goal, timeline, and risk tolerance {#a-decision-framework-match-the-path-to-your-goal-timeline-and-risk-tolerance}
...
## What order to learn in, and how to schedule it once you've chosen {#what-order-to-learn-in-and-how-to-schedule-it-once-youve-chosen}
...
## The honest caveats {#the-honest-caveats}
