...
## The Two Categories of AI Skills {#the-two-categories-of-ai-skills}
...
## AI Coding Assistants (Tools You Use) {#ai-coding-assistants-tools-you-use}
...
### Claude (via API or Claude.ai) {#claude-via-api-or-claudeai}
...
### How to Use These Effectively {#how-to-use-these-effectively}
...
## AI Engineering (Features You Build) {#ai-engineering-features-you-build}
...
### Where to Learn AI Engineering {#where-to-learn-ai-engineering}
...
## The Career Impact {#the-career-impact}
...
## The Practical First Step {#the-practical-first-step}
