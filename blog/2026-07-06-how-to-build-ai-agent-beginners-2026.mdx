...
## The short version: an agent is an LLM that can take actions {#the-short-version-an-agent-is-an-llm-that-can-take-actions}
...
## What is MCP (Model Context Protocol), in plain terms {#what-is-mcp-model-context-protocol-in-plain-terms}
...
## What context engineering actually means {#what-context-engineering-actually-means}
...
## What you need before you build your first agent {#what-you-need-before-you-build-your-first-agent}
...
## Build your first AI agent: a worked example {#build-your-first-ai-agent-a-worked-example}
...
## Context engineering for agents that don't fall over {#context-engineering-for-agents-that-dont-fall-over}
...
## From toy agent to a structured build {#from-toy-agent-to-a-structured-build}
...
## Common beginner mistakes when building AI agents {#common-beginner-mistakes-when-building-ai-agents}
