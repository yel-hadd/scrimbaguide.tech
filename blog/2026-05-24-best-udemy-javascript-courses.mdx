...
## How we filtered the catalog {#how-we-filtered-the-catalog}
...
## 1. The Complete JavaScript Course: From Zero to Expert by Jonas Schmedtmann {#1-the-complete-javascript-course-from-zero-to-expert-by-jonas-schmedtmann}
...
## 2. JavaScript: The Complete Guide (Beginner + Advanced) by Maximilian Schwarzmüller {#2-javascript-the-complete-guide-beginner--advanced-by-maximilian-schwarzmüller}
...
## 3. Modern JavaScript From The Beginning 2.0 by Brad Traversy {#3-modern-javascript-from-the-beginning-20-by-brad-traversy}
