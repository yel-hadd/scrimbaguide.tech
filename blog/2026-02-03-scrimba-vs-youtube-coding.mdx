...
If you need to learn how to deploy a Next.js app to Vercel, or configure ESLint for TypeScript, YouTube probably has a 10-minute walkthrough. This is reference content, not curriculum. For the smaller "why does this line do that" questions, Scrimba now has an answer of its own: the EXPLAIN button in every lesson sends the code to [Scrimba Explain](/docs/how-it-works/scrimba-explain/), which builds a short narrated video, 10 free for life and 100 a month on Pro.
...
2. **YouTube** for supplementary content, exploration, trends, conference talks (and Scrimba Explain for the quick "explain this" questions that used to mean a new YouTube search)
