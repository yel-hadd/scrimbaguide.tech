...
## What to learn to code this summer 2026 (the short answer) {#what-to-learn-to-code-this-summer-2026-the-short-answer}
...
## Why summer is the best window a beginner gets {#why-summer-is-the-best-window-a-beginner-gets}
...
## Pick one track, not five {#pick-one-track-not-five}
...
## The nine-week plan, week by week (June 29 to August 30) {#the-nine-week-plan-week-by-week-june-29-to-august-30}
...
## How many hours a day do you actually need? {#how-many-hours-a-day-do-you-actually-need}
...
## The summer traps: vacations, motivation dips, and tutorial hell {#the-summer-traps-vacations-motivation-dips-and-tutorial-hell}
...
## Only have August? The compressed four-week version {#only-have-august-the-compressed-four-week-version}
...
## What to build, and why a shipped project beats a certificate {#what-to-build-and-why-a-shipped-project-beats-a-certificate}
...
## Where Scrimba fits this summer plan {#where-scrimba-fits-this-summer-plan}
...
Scrimba is built around editing real code in the browser, and its JavaScript and React courses are free to start, so you can run the first weeks of this plan without paying anything and find out whether the interactive format works for you. If it does and you want the full sequenced path plus projects, Scrimba Pro is a low monthly subscription (see current [Scrimba pricing](/docs/pricing/)).
