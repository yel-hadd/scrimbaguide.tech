...
## Why Most People Quit {#why-most-people-quit}
...
## The Tiny Habits Framework {#the-tiny-habits-framework}
...
### Applied to Learning Code {#applied-to-learning-code}
...
## Why Scrimba's Format Helps {#why-scrimbas-format-helps}

Scrimba's interactive scrim format is uniquely suited to habit building:

### Low Friction to Start {#low-friction-to-start}
...
### Bite-Sized Lessons {#bite-sized-lessons}
...
### The Interactive Loop {#the-interactive-loop}
...
### Find an Accountability Partner {#find-an-accountability-partner}
...
### Attend the Weekly Town Hall {#attend-the-weekly-town-hall}
...
## A Weekly Study Plan Template {#a-weekly-study-plan-template}
...
## Dealing with the Hard Parts {#dealing-with-the-hard-parts}

### When You Hit a Wall {#when-you-hit-a-wall}
...
### When Life Gets Busy {#when-life-gets-busy}
...
### When Progress Feels Slow {#when-progress-feels-slow}
...
## Track Your Streaks {#track-your-streaks}
