...
## The short version: use AI as a tutor, never as autocomplete {#the-short-version-use-ai-as-a-tutor-never-as-autocomplete}
...
## Why AI dependency happens (the cognitive-offloading trap) {#why-ai-dependency-happens-the-cognitive-offloading-trap}
...
## How dependent learners already are in 2026 (the data) {#how-dependent-learners-already-are-in-2026-the-data}
...
## The method: six rules for learning with AI without the crutch {#the-method-six-rules-for-learning-with-ai-without-the-crutch}
...
## Good prompts vs crutch prompts (copy-paste examples) {#good-prompts-vs-crutch-prompts-copy-paste-examples}
...
## When it is actually fine to let AI drive {#when-it-is-actually-fine-to-let-ai-drive}
...
## Practice where you literally cannot copy-paste {#practice-where-you-literally-cannot-copy-paste}
...
## A 30-day plan to keep your raw coding skill while you use AI {#a-30-day-plan-to-keep-your-raw-coding-skill-while-you-use-ai}
