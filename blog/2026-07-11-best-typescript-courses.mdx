...
## 1. Learn TypeScript by Bob Ziroll (Scrimba) {#1-learn-typescript-by-bob-ziroll-scrimba}
...
## 2. Understanding TypeScript by Maximilian Schwarzmüller (Udemy) {#2-understanding-typescript-by-maximilian-schwarzmüller-udemy}
...
## 3. Total TypeScript by Matt Pocock {#3-total-typescript-by-matt-pocock}
...
## 4. TypeScript on Frontend Masters (Mike North) {#4-typescript-on-frontend-masters-mike-north}
