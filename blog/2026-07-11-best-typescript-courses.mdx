...
<ItemListSchema
  ...
  items={[
    { name: "Learn TypeScript by Bob Ziroll (Scrimba)", url: "/docs/courses/typescript/learn-typescript", description: "Free interactive course, 4.2 hours and 79 lessons, covering TypeScript fundamentals, TypeScript in React, and TypeScript in Express." },
    ...
    { name: "Total TypeScript by Matt Pocock", url: "https://www.totaltypescript.com/", description: "Interactive exercises plus video on advanced typing, aimed at developers who already use TypeScript daily." },
    { name: "TypeScript on Frontend Masters (Mike North)", description: "Recorded workshop with a structured fundamentals to advanced arc, best if a subscription is already paid for." },
  ]}
/>
