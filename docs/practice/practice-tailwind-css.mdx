...
## Why Practice Tailwind on Scrimba? {#why-practice-tailwind-on-scrimba}
...
## Top Courses to Practice Tailwind CSS {#top-courses-to-practice-tailwind-css}
...
## Tailwind Practice Challenges {#tailwind-practice-challenges}

### Challenge 1: Responsive Navbar {#challenge-1-responsive-navbar}
Build a navigation bar that collapses to a hamburger menu on mobile. Practice: `flex`, `hidden`, `md:flex`, `space-x-4`.

### Challenge 2: Card Grid {#challenge-2-card-grid}
...
### Challenge 3: Dark Mode Toggle {#challenge-3-dark-mode-toggle}
...
### Challenge 4: Animated Button {#challenge-4-animated-button}
