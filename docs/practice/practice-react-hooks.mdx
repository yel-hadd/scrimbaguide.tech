...
You should already know `useState` and JSX basics. Keep <AffiliateLink href="https://scrimba.com/learn-react-c0e">Learn React</AffiliateLink> (see the [course page](/docs/courses/react/learn-react/)) open in another tab, or a blank scrim, to paste each snippet in and run it. Scrimba's editor lets you pause, edit, and rerun instantly; the free course needs no card, and its one-time 20% banner can be dismissed.
...
| --- | --- | --- | --- |
| [Learn React](/docs/courses/react/learn-react/) | `useState`, `useEffect`, component fundamentals | Free | 15.1 hrs |
| [What's New in React 19?](/docs/courses/react/whats-new-in-react-19/) | Hook-adjacent API changes since React 18 | Free | 1.2 hrs |
| [Advanced React](/docs/courses/react/advanced-react/) | Custom hooks, context, performance patterns | Pro | 18.8 hrs |
| [React Interview Questions](/docs/courses/react/react-interview-questions/) | Rules of hooks and common gotchas | Pro | 41 min |
