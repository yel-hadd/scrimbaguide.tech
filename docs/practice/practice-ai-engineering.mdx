...
<FAQAccordion items={[
  ...
  { q: "Which AI courses on Scrimba are free?", a: "Intro to Model Context Protocol (MCP) and Intro to Mistral AI are free. The AI Engineer Path and specialized courses like Learn RAG and Learn AI Agents require Scrimba Pro." },
