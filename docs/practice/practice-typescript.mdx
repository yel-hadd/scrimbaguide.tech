---
title: "Where to Practice TypeScript: Interactive Courses & Exercises"
...
# Learn TypeScript by breaking it on purpose

**Quick answer:** Scrimba runs **TypeScript in the browser player**—pause a cast, widen a type, watch the compiler yell, fix it. Pair **[Learn TypeScript](/docs/courses/typescript/learn-typescript)** with **free JavaScript** + **React** scrims so types meet real components, not toy `.ts` files.
