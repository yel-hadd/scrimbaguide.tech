...
| --- | --- | --- | --- |
| [Learn JavaScript](/docs/courses/javascript/learn-javascript/) | Array methods across 140+ challenges and three projects | Free | 9.4 hrs |
| [JavaScript Interview Challenges](/docs/courses/javascript/javascript-interview-challenges/) | Timed array and string questions, interview format | Pro | 2.3 hrs |
| [Advanced JavaScript](/docs/courses/javascript/advanced-javascript/) | Closures and the internals behind array methods | Pro | 9.8 hrs |
| [Data Structures and Algorithms](/docs/courses/javascript/data-structures-and-algorithms/) | Complexity (the O(n \* m) trap from Drill 6), sorting | Pro | 2.5 hrs |
