...
|---|---|---|---|
| [Learn JavaScript](/docs/courses/javascript/learn-javascript/) | `fetch` and async/await without a framework | Free | 9.4 hrs |
| [Learn React](/docs/courses/react/learn-react/) | `useEffect` data fetching, loading and error states | Free | 15.1 hrs |
| [Build a React Project: Movie Search App](/docs/courses/react/a-react-project-movie-search-app/) | Debounced search against a live API | Pro | 57 min |
| [Learn Node.js](/docs/courses/javascript/nodejs/) | Building the REST endpoints you fetch from | Free | 3.5 hrs |
