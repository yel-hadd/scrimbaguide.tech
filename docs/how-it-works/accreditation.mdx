...
## What accreditation actually means {#what-accreditation-actually-means}
...
## What Scrimba is instead {#what-scrimba-is-instead}
...
## When accreditation matters {#when-accreditation-matters}
...
## When accreditation does not matter {#when-accreditation-does-not-matter}
...
## How to talk about Scrimba on a CV without overclaiming {#how-to-talk-about-scrimba-on-a-cv-without-overclaiming}
...
- [Scrimba certificates FAQ](/docs/how-it-works/certificates): what the path certificates actually do
