...
A scrim is an interactive lesson where the instructor's code is live and editable, pause the video, edit the code in-place, run it, and resume. This zero-setup format converts passive watching into active coding and accelerates skill retention.

Scrimba's defining feature, the one reviewers mention most often, is the interactive scrim format. It's the single biggest reason learners choose Scrimba over every other coding platform.

This page explains exactly how it works and why it matters.

## Who This Is For

Best for: learners evaluating interactive formats, complete beginners, career changers, and developers who want hands-on instruction that reduces setup friction.
