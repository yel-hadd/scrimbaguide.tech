...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The Backend Migration Super Challenge workspace at 0:00, with the Vite front end and Node server both live in Scrimba's Runner panel and the Gift Genie UI on the right waiting for a prompt."
/>
