...
<Screenshot
  ...
  width={1277}
  height={718}
  caption="This module covers generating, prompting, sizing, inpainting and varying images with DALL-E 2 and 3."
  source=""
/>
...
<Screenshot
  ...
  alt="Intro to Dall-E and GPT Vision, Editing images lesson: the code editor showing an image-edit API call before it runs."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Intro to Dall-E and GPT Vision, FilmFusion challenge lesson: the code editor showing the project brief as a comment."
  width={1400}
  height={635}
...
<Screenshot
  ...
  width={1277}
  height={718}
  caption="This module switches from generating images to reading them, sending a text-and-image content array to chat completions."
...
<Screenshot
  ...
  alt="Intro to Dall-E and GPT Vision, GPT-4 with Vision lesson: the code editor, console answer and a photo of an egg."
  width={1400}
  height={635}
