...
<Screenshot
  ...
  width={1377}
  height={775}
  caption="This module recaps RAG in slides, then embeds a sample text file with OpenAI's text-embedding-3-small model."
  source=""
/>
...
<Screenshot
  ...
  alt="Build a Support Agent with Vercel AI SDK, tool-calling challenge: code editor showing a commented exercise brief and price table."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Build a Support Agent with Vercel AI SDK, Agentic Retrieval Routing slide: a flowchart splits a question into two answer paths."
  width={1377}
  height={775}
  caption="This module classifies each question as GENERAL or RETRIEVAL, then adds OpenAI's web search tool alongside the knowledge base."
...
<Screenshot
  ...
  alt="Build a Support Agent with Vercel AI SDK, Agentic Retrieval Routing lesson: code editor and terminal output showing the classifier's result."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Build a Support Agent with Vercel AI SDK, finished agent lesson: code editor beside a live chatbot preview answering a support question with sources."
  width={1400}
  height={660}
