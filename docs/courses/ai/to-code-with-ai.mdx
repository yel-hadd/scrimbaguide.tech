...
sidebar_label: "Learn to Code with AI"
...
Scrimba's free, beginner course on building small web projects with ChatGPT as your coding partner, taught by Guil Hernandez across about 4.5 hours. I opened all 42 scrims and read the transcript of every one that has a transcript (40 of them) with a Pro account in September 2026. This page is what is actually inside, including the parts that show their age.
...
Learn to Code with AI is a free, three-module course of about 4.5 hours in which you paste prompts into ChatGPT, drop the code it returns into the Scrimba editor, and then change it by hand. You build about 15 mini projects, among them a drum kit, a whack-a-mole game, a Chrome extension, and four small apps backed by a Firebase database. The FAQ at the bottom lists all of them. Nothing in the course is behind a paywall.

It is not a programming course. Guil says so in the first scrim: the aim is "prototyping and building cool projects with AI's assistance without worrying about all the tedious foundational stuff." If you want to ship something this weekend and do not care yet how a `for` loop works, this is the right door. If you want to become a developer, treat it as a warm-up and move to [Learn JavaScript](/docs/courses/javascript/learn-javascript/) afterwards.
...
<Screenshot
  ...
  alt="Scrimba Learn to Code with AI lesson Debug, get feedback, and improve your code, paused at 6:31: a slide shows ChatGPT explaining that applyDiscount uses the assignment operator = instead of === to compare userCode with HALF, with corrected JavaScript below, over the prompts.md file in the editor and a small ReelRewards preview pane"
  width={1400}
  height={605}
...
<Screenshot
  ...
  alt="Scrimba Learn to Code with AI lesson Build a Whac-a-Mole style game called FaceBomp, paused at 12:05: the preview pane shows the FaceBomp game mid-round with Score 2, a timer reading Time left: Time left: 21 seconds seconds, and the instructor's photo popping out of one of six blue holes, while script.js on the left declares score, time, and a displayImage function"
  width={1400}
  height={617}
...
<Screenshot
  ...
  alt="Scrimba Learn to Code with AI lesson RoadWallet app, paused at 8:19: index.js imports initializeApp and database functions from firebasejs 9.20.0 and reads databaseURL from process.env.ROAD_WALLET_DB, while the preview pane shows the RoadWallet form with an Accommodations expense of 600 and an Expense History listing Food $500 and Accommodations $600 with delete buttons"
  width={1400}
  height={617}
