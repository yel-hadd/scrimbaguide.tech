...
<Provenance subject="course" date={frontMatter.reviewed} detail="all 42 scrims opened, 40 transcripts read" />

*This page is part of our [Scrimba AI courses](/docs/courses/ai/) catalog. This course is not part of any Scrimba career path.*
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="A login button, a hero section, a signup form, and a drum kit teach the paste-run-edit loop, ending in a Netlify deploy."
  source=""
/>
...
<Screenshot
  ...
  width={1400}
  height={605}
  caption="At 6:31 of the debugging challenge answer, ChatGPT spots that if (userCode = 'HALF') assigns instead of compares."
/>
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="FaceBomp, a personal homepage, a smart home interface, and a Chrome extension move from one big prompt to many small ones."
  source=""
/>
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Four apps, a reconnected GIF Gala, Kudos Delight, LunchVote, and RoadWallet, save and sync data through Firebase's Realtime Database."
...
<Screenshot
  ...
  width={1400}
  height={617}
  caption="This is what asking ChatGPT for the whole file, not a diff, gets you: RoadWallet's rewrite at 8:19 now saves expenses and travelers to Firebase."
/>
...
Nothing in the course is gated. All 40 module scrims, all 23 challenges, and the three Firebase apps are free. There are no Solo Project (Pro) items, which is unusual for a Scrimba course. The only Pro item is the Certificate of Completion at the end of the table of contents.

Scrimba's pricing page lists basic Discord access as free and the Pro-only channels as Pro, so the Discord server Guil points to in the intro is not a reason to upgrade. See <AffiliateLink href="https://scrimba.com/our-pricing">current plans</AffiliateLink> if you want the certificate.
...
<FAQAccordion items={[
  { q: "Is Learn to Code with AI free on Scrimba?", a: "Yes. All 40 module scrims, all 23 challenges, and the Firebase projects are free with no card required. There are no Pro solo projects in this course. Pro only adds the certificate." },
