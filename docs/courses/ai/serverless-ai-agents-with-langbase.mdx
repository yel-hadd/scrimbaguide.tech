...
<Screenshot
  ...
  alt="Title card of Scrimba's Build Serverless AI Agents with Langbase course, teacher Maham Codes, on a purple and olive gradient."
  width={1280}
  height={720}
...
What Pro adds around it: the Certificate of Completion listed at the end of the table of contents, and the Pro-only Discord channels (basic Discord access is free). This course is not part of the [AI Engineer Path](/docs/paths/ai-engineer-path/); see <AffiliateLink href="https://scrimba.com/our-pricing">current plans</AffiliateLink> if that path is what you want.
