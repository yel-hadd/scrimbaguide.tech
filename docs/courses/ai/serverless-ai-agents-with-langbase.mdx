...
<Screenshot
  ...
  width={1280}
  height={720}
  caption="This module defines agentic RAG and Langbase's pipes and memory agents, then sets up the API key in Scrimba's environment variables."
  source=""
/>
...
<Screenshot
  ...
  width={1280}
  height={720}
  caption="This module creates a Langbase memory, uploads the FAQ file to it, then explains the parse, chunk, embed and index pipeline behind that upload."
...
<Screenshot
  ...
  alt="Build Serverless AI Agents with Langbase, Create a Memory challenge: a code editor sits above an empty terminal waiting for the run."
  width={1400}
  height={684}
...
<Screenshot
  ...
  alt="Build Serverless AI Agents with Langbase, Memory Agents lesson: a hand-drawn diagram traces data from upload to a vector store."
  width={1280}
  height={720}
...
<Screenshot
  ...
  alt="Build Serverless AI Agents with Langbase, Generate RAG Responses lesson: the terminal prints the finished agent's grounded answer."
  width={1400}
  height={684}
