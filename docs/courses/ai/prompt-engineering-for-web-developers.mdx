...
<Provenance subject="course" date={frontMatter.reviewed} detail="all 50 scrims opened and transcribed" />
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Eighteen scrims teach specificity, context, format control, breaking tasks into steps, and iterating on a prompt."
  source=""
/>
...
<Screenshot
  ...
  alt="Prompt Engineering for Web Developers, Basics Part 2 lesson: code editor beside a browser preview reversing typed text."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Prompt Engineering for Web Developers, Break Tasks lesson: code editor beside a preview of a budget tracker with colored bars."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Twenty scrims use ChatGPT to generate, test, debug, convert, and document code, from pseudocode to a jQuery-to-vanilla-JS conversion."
  source=""
/>
...
<Screenshot
  ...
  alt="Prompt Engineering for Web Developers, Convert Code challenge: code editor beside a preview of a rocket launch countdown app."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Ten scrims use AI to study algorithms, review code for Big O, run mock interviews, and draft resume bullets and a pitch."
