...
*This page is part of our [Scrimba AI courses](/docs/courses/ai/) catalog. It's a standalone course, not part of the [AI Engineer Path](/docs/paths/ai-engineer-path/).*
...
- [AI Engineer Path](/docs/paths/ai-engineer-path/), where the engineering courses are sequenced

<FAQAccordion items={[
  { q: "Is Prompt Engineering for Web Developers free?", a: "No. The first five scrims (welcome, intro, Basics Part 1 and 2, and the quiz) are free previews. The other 43 lessons and the certificate need Scrimba Pro. This course is not part of the AI Engineer Path. The free AI starting points are Learn to Code with AI and Intro to Mistral AI." },
