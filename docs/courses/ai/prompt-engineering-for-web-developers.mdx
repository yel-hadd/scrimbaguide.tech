...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Basics Part 2 at 2:32. The HTML came straight from ChatGPT, and the preview shows it running once the script tag is pointed at index.js, the one manual fix."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The rebuilt budget tracker at 7:12, after a run of small prompts instead of one big one: the ProgressBar component on the left is ChatGPT's code with the final fix applied, width capped at 100%."
/>
