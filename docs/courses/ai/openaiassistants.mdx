...
This is a standalone Pro course under Scrimba's AI topic, not part of the [AI Engineer Path](/docs/paths/ai-engineer-path/). On this site it sits at the applied end of the [AI courses catalog](/docs/courses/ai/), next to [Learn RAG](/docs/courses/ai/rag/), which teaches the manual pipeline this API was designed to hide, and [Learn AI Agents](/docs/courses/ai/ai-agents/), which covers tool calling in a provider-neutral way. Read it as historical context for those two rather than as a prerequisite.
