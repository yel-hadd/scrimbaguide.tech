...
Scrimba's short Pro course on keeping an AI chat app from forgetting or crashing as a conversation grows, taught by Arsala Khan in about an hour. It is a flat list of 15 scrims. I read the transcript of every one of them and opened the code in each, challenge briefs and solutions included, with a Pro account in September 2026. This is what is in there.

*This page is part of our [Scrimba AI courses](/docs/courses/ai/) catalog. Scrimba's course page does not list it under a career path, though the instructor builds the [AI Engineer Path](/docs/paths/ai-engineer-path/) and the material fits there.*

## Quick answer

Learn Context Engineering is a one-hour, intermediate, Pro course on three techniques: system prompts, trimming old messages so a request fits the model's context window, and asking the model to summarize older messages instead of dropping them. You work in one small vanilla JavaScript chat app built on the Vercel AI SDK (version 5) and OpenRouter. Six of the 15 scrims stop and hand you a challenge, each with a hints folder. If you already call an LLM from JavaScript and want to know why your app breaks after twenty messages, this is a tight, practical fix. If you have never called a model before, start with [Intro to AI Engineering](/docs/courses/ai/ai-engineering/) instead.
