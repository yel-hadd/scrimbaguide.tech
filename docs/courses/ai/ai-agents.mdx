...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Nine numbered parts turn this reason-act-observe flowchart into a hand-written loop with regex parsing and a five-iteration cap."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn AI Agents, ReAct Agent part 7: code editor and console panel showing the parsed function call."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn AI Agents, ReAct Agent part 9: the console lists each loop iteration next to the code editor."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="The hand-written loop gets rebuilt with a tools schema, a finish_reason check, and the beta runFunctions helper."
...
<Screenshot
  ...
  alt="Learn AI Agents, Adding UI lesson: a chat window preview beside the code editor showing the agent's reply."
  width={1400}
  height={660}
