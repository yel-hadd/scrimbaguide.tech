...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="By 4:04, Part 7's regex has pulled getLocation and null out of the model's text, and availableFunctions[action](actionArg) is about to call the stub with them."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="ReAct Agent Part 9 at 4:40. Iteration 2 calls getCurrentWeather with the city iteration 1 just found, iteration 3 answers: the whole ReAct loop in one console."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 3:20 of Adding UI to agent, the dependency panel reads openai@4.19.1, up from the 4.14.2 shown in the two ReAct screenshots earlier in this review."
/>
