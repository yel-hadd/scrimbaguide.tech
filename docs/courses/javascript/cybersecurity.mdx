...
<Screenshot
  ...
  alt="Title card of module 1 in Scrimba's Learn Cybersecurity course: Backend Security, thinking with STRIDE and OWASP."
  width={1280}
  height={720}
  caption="This module has you classify six QuickBite threats with STRIDE, then map six bug reports onto the OWASP top ten."
  source=""
/>
...
<Screenshot
  ...
  width={1280}
  height={720}
  caption="This module teaches sessions, stateless JWTs and delegated OAuth identity, each ending in a challenge that fixes broken code."
...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="SQL Injection part 2 at 3:53, seconds after Jonathan submits it. This is the attack you typed yourself, not a slide about parameterised queries."
/>
...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="The remainingRequests property, read with optional chaining, is the last step in Create the limiter at 5:08, right where the rate limit kicks in."
/>
