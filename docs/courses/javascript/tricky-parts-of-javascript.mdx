...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Six scrims on var, let, const and hoisting, ending in a challenge that mixes every rule from the block."
...
<Screenshot
  ...
  alt="The Tricky Parts of JavaScript, Hoisting lesson: the console shows a ReferenceError instead of the expected value."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="The Tricky Parts of JavaScript, Scope Challenge lesson: the console prints six answers after running the code."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="The Tricky Parts of JavaScript, Promise.all lesson: a Click Me button in the preview and an array in the console."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="The Tricky Parts of JavaScript, Promises Challenge lesson: the code editor with an async await one-liner and its console output."
  width={1400}
  height={660}
