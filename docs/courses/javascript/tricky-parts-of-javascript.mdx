...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 1:35 of Hoisting, the inner let is declared after the console.log, yet the log throws instead of printing the outer 'a'."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Just after Zack runs the Scope Challenge file at 1:00, line 32, var hoisted = true, is why the first log prints nothing."
/>
