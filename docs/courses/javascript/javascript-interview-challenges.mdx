...
<Provenance subject="course" date={frontMatter.reviewed} detail="transcripts read for all 62 scrims, code opened in every challenge" />
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="This scrim covers Treasure's method: pseudo code first, built-in methods over cleverness, and thinking out loud."
...
<Screenshot
  ...
  alt="JavaScript Interview Challenges, FizzBuzz solution: a code editor and console list bonus messages for employee IDs."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="JavaScript Interview Challenges, Chef Mario solution: a code editor shows a function body written as pseudo code only."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="JavaScript Interview Challenges, Emoji Flower Bed challenge: a preview shows a grid of animal emoji with few flowers."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="JavaScript Interview Challenges, Emoji Slot Machine solution: a preview shows rows of fruit emoji from an API fetch."
  width={1400}
  height={660}
