...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The FizzBuzz solution paused at 4:01. The i % 15 check comes first, because employee 30 would otherwise get a vacation instead of the jackpot."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 1:26 of Chef Mario, solution part 2, this frame is the shape nearly every solution scrim in the course follows: a plan typed as comments, then the code."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The fetch already works in the Emoji Flower Bed brief at 0:11; your job is the empty clearTheGarden function that filters it down to bugs and flowers."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Nine HTML codes in the console prove the fetch chain worked at 4:36 of the slot machine solution, and the hard-coded fruit beneath it gets deleted from index.html a few seconds later."
/>
...
Scrimba's catalog data puts this course on three paths, and it belongs near the end of the [Frontend Developer Path](/docs/paths/frontend-developer-path/), the [Fullstack Developer Path](/docs/paths/fullstack-developer-path/), and the [Backend Developer Path](/docs/paths/backend-developer-path/), once the JavaScript fundamentals are solid. It pairs naturally with [Frontend Interview Tips](/docs/courses/javascript/frontend-interview-tips/), which covers the questions that are not code, and it is the gentle on-ramp to [Data Structures and Algorithms](/docs/courses/javascript/data-structures-and-algorithms/) if you need the harder material.
