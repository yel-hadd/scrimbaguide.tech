...
This course is part of the [Frontend Developer Path](/docs/paths/frontend-developer-path/) and the [Fullstack Developer Path](/docs/paths/fullstack-developer-path/). The natural place for it is right after [Learn HTML and CSS](/docs/courses/css/html-and-css/) and before or alongside [Learn JavaScript](/docs/courses/javascript/learn-javascript/), so the habits are in place before you start building interactive components. It pairs well with [Build a Multi-Page Website with HTML and CSS](/docs/courses/javascript/a-space-travel-website/), which is where you will next write a nav, a form and a set of images that need this treatment.
...
- [Frontend Developer Path](/docs/paths/frontend-developer-path/), which includes this course
...
<FAQAccordion items={[
  ...
  { q: "Is it part of a path?", a: "Yes. It is inside the Frontend Developer Path and the Fullstack Developer Path, which lines up with Fredrik's bio saying it launched through the Frontend Developer Path." },
]} />
