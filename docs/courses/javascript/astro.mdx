...
<div className="screenshot-grid">
  <Screenshot
    src="/img/scrimba/intro-to-astro/course-intro-to-astro-title-card.webp"
    alt="Title card of Scrimba's Intro to Astro course: Intro to Astro, the web framework for content-driven websites, teacher James Q Quick, on a blue and purple gradient"
    width={1280}
    height={720}
    caption="The course title card, the first slide of the intro scrim. The course is a flat list of 37 scrims with no chapter cards after this one."
...
<Screenshot
  src="/img/scrimba/intro-to-astro/adding-styles-scoped-css-should-be-red-lesson.webp"
  alt="Scrimba's Adding styles scrim in Intro to Astro paused at 2:21: index.astro has a style block setting p.description to red, and the preview shows the header's description paragraph still black while a paragraph placed directly in index.astro, reading Should be red, is red"
  width={1400}
  height={684}
  caption="Adding styles at 2:21. The same p.description rule colours the paragraph that lives in index.astro and ignores the one inside the Header component. That is Astro's scoped styling, shown before it is explained."
/>
...
<Screenshot
  src="/img/scrimba/intro-to-astro/content-collections-define-collection-zod-schema-lesson.webp"
  alt="Scrimba's Content collections in Astro scrim paused at 2:10: content.config.ts defines a project collection with a file loader pointing at src/data/projects.json and a Zod schema of title, optional description, image and slug, exported as collections, with the Astra portfolio site in the preview"
  width={1400}
  height={684}
  caption="Content collections in Astro at 2:10: the whole content.config.ts. A file loader, a Zod schema, one export, and from here on the projects data is typed everywhere you query it."
/>
