...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="Adding styles at 2:21. p.description colours only the paragraph in index.astro; the Header component's copy of it stays untouched, Astro's scoped styles at work."
/>
...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="The whole of content.config.ts fits on screen at 2:10 of Content collections in Astro: a file loader, a Zod schema, one export, and from here the projects data is typed everywhere you query it."
/>
