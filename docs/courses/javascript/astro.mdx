...
It fits you if you want a fast portfolio, blog, or docs site and already write HTML, CSS, and basic JavaScript. The catch: it ships zero client-side JavaScript, so islands, framework integrations, and server endpoints only get named in the wrap-up as next steps. Want an interactive app instead? [Learn React](/docs/courses/react/learn-react/) is the better starting point.
...
<CourseSchema
  ...
  instructor="James Q Quick"
  instructorUrl="https://scrimba.com/@jamesqquick"
  imageUrl="https://scrimbaguide.tech/img/scrimba/intro-to-astro/course-intro-to-astro-title-card.webp"
/>
