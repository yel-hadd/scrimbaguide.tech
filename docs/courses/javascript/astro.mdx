...
<Screenshot
  ...
  width={1280}
  height={720}
  caption="The opening scrim: James's case for Astro and a tour of the finished site, before setup with npm create astro@latest."
...
<Screenshot
  ...
  alt="Intro to Astro, Adding styles lesson: browser preview showing one red paragraph and one still black despite the same CSS rule."
  width={1400}
  height={684}
...
<Screenshot
  ...
  alt="Intro to Astro, Content collections lesson: code editor showing a schema file beside a preview of the portfolio site."
  width={1400}
  height={684}
