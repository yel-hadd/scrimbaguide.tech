...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="At 3:26 of Our first test, Dylan deletes the || '' default from firstName, and the result reads Expected null to be ''."
/>
...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="The Spy Challenge brief as the scrim opens: three numbered lines and an empty describe block, with a hint for a method the course has not taught yet."
/>
