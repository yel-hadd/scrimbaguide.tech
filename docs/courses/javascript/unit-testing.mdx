...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Five scrims make the case for testing, define a unit test, and wire up Jasmine from script tags with no npm install."
...
<Screenshot
  ...
  alt="Introduction to Unit Testing, first test lesson: a code editor beside a test reporter turning red on a failed check."
  width={1400}
  height={684}
...
<Screenshot
  ...
  alt="Introduction to Unit Testing, spy challenge lesson: a code editor shows an empty test block and a no specs found reporter."
  width={1400}
  height={684}
