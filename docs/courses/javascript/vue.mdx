...
<Provenance subject="course" date={frontMatter.reviewed} detail="all 26 teaching scrims opened and transcripts read" />
...
<Screenshot
  ...
  alt="Learn Vue, Your First Solo Vue App challenge: a code editor with a numbered brief above a static 404 page."
  width={1400}
  height={684}
...
<Screenshot
  ...
  alt="Learn Vue, Reactivity and Template Syntax lesson: a code editor and preview of a Vue Facts page with three cards."
  width={1400}
  height={684}
