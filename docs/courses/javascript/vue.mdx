...
<Screenshot
  src="/img/scrimba/learn-vue/first-solo-vue-app-404-challenge-brief-lesson.webp"
  alt="Scrimba's Your First Solo Vue App scrim paused at 1:15: index.html holds a static 404 page and a five-step challenge comment (include the Vue CDN, wrap everything in #app, import createApp and ref, create and mount an app, replace four texts with ref variables), with the 404 page rendered in the preview"
  width={1400}
  height={684}
  caption="Your First Solo Vue App at 1:15. The brief is a five-step comment under a static 404 page; hint.md in the tab bar holds the syntax if you get stuck. Rachel walks through her own solution from 1:36."
/>
...
<Screenshot
  src="/img/scrimba/learn-vue/reactivity-template-syntax-vue-facts-lesson.webp"
  alt="Scrimba's PROJECT Reactivity and Template Syntax scrim paused at 5:14: Main.vue renders three sections from facts[0], facts[1] and facts[2] with text interpolation, and the green Vue Facts preview shows Hi, I'm Vue with the Lightweight, Approachable and Versatile cards"
  width={1400}
  height={684}
  caption="The project scrim at 5:14, the three facts now coming from the facts array by index. Rachel admits the copy-paste is clumsy ('hold your horses') and defers v-for to a section that does not exist yet."
/>
