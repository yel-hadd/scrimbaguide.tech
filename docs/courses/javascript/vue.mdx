...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="Your First Solo Vue App's five-step brief runs at 1:15, and Rachel's own solution runs from 1:36."
/>
...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="By 5:14 of the project scrim, the three facts come from the facts array by index. Rachel admits the copy-paste is clumsy ('hold your horses') and defers v-for to a section that does not exist yet."
/>
