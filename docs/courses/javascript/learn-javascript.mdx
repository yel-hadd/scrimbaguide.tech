...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The calculator challenge, paused at 3:39. Per writes the bug on purpose: 'Sum: ' + 8 + 2 renders 'Sum: 82' in the preview, fixed by computing the result before concatenating."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The blackjack recap at 2:09, walking back through renderGame(): a for loop over the cards array, the if/else-if/else that sets the message, and the && check that guards newCard()."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Lesson Make the delete button work in the Chrome extension module. The three numbered comments at the top of the file are the challenge brief, the state you edit before Per's solution."
/>
