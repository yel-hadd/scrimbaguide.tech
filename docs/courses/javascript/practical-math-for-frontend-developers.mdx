...
<Screenshot
  ...
  alt="Title card of Scrimba's Practical Math for Front-End Developers course: the name above sigma, infinity, pi and other symbols."
  width={1279}
  height={720}
...
<Screenshot
  ...
  alt="Title card reading Your roll() Function with a single white die, from Scrimba's Practical Math for Frontend Developers course."
  width={1279}
  height={720}
