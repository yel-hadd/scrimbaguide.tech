...
<Screenshot
  ...
  alt="Scrimba's Adding the functionality scrim paused at 6:41: index.css shows the mobile-navigation media query with position fixed, inset 0 0 0 30%, transform translateX(100%), and Kevin mid-way through typing the .primary-navigation data-visible selector, with the phone-sized preview in the corner"
  width={1400}
  height={684}
