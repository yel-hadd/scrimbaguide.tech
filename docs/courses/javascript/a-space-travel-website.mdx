...
<Provenance subject="course" date={frontMatter.reviewed} detail="every module expanded, 31 of the 67 scrims opened and transcribed" />
...
<Screenshot
  ...
  alt="Build a Multi-Page Website with HTML and CSS: the finished Space Travel homepage with a starfield and Explore button."
  width={1176}
  height={789}
...
<Screenshot
  ...
  alt="Build a Multi-Page Website with HTML and CSS, grid container lesson: the preview with two columns outlined in red and yellow."
  width={1400}
  height={684}
...
<Screenshot
  ...
  alt="Build a Multi-Page Website with HTML and CSS, mobile nav lesson: the code editor beside a phone-sized preview of the menu."
  width={1400}
  height={684}
