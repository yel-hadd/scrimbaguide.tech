...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="translateX(100%) pushes the menu off screen at 6:41 of Adding the functionality, and the selector being typed brings it back when the script flips data-visible to true."
/>
