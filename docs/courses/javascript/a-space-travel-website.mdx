...
This fits developers who already write HTML and CSS and want practice turning a real design into a site. The catch: it's tied to a single layout, and the JavaScript is two small files in service of the design, not a language lesson. Finish it and [Learn JavaScript](/docs/courses/javascript/learn-javascript/) is the natural next stop.
...
<CourseSchema
  ...
  instructor="Kevin Powell"
  instructorUrl="https://scrimba.com/@kevin-powell"
  imageUrl="https://scrimbaguide.tech/img/scrimba/build-a-space-travel-website/finished-space-travel-site-homepage-preview.webp"
/>
