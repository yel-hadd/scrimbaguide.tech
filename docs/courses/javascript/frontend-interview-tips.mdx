...
<Screenshot
  ...
  width={1400}
  height={684}
  caption="At 3:18 of Promises, the order comes out 1, 3, 2 because the .then callback logs after the synchronous code finishes, the exact order the question is testing."
/>
