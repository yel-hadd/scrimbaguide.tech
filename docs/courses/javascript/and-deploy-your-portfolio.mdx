...
sidebar_label: "Build and Deploy Your Portfolio"
...
Kevin Powell's free course on building a one-page developer portfolio in HTML and CSS, then putting it on a DigitalOcean server. It is short, so I opened all 23 scrims and read the transcript of every one with a Pro account in September 2026. What follows is what the course actually does, lesson by lesson, including the parts that show their age.

*This page is part of our [Scrimba JavaScript courses](/docs/courses/javascript/) catalog. Scrimba files it under Career rather than in any path; it is not listed as part of the [Frontend Developer Path](/docs/paths/frontend-developer-path/).*

## Quick answer

Build and Deploy Your Portfolio is a free, 2.4 hour follow-along course by Kevin Powell. Across 23 scrims you build a "Jane Smith, front-end dev" portfolio: header with a hamburger menu, intro, services, about me, a responsive grid of work samples, a footer with social icons, plus a template page for individual projects. The last two lessons are slide walkthroughs of renting a DigitalOcean droplet and uploading the files over SFTP. There are no challenges and no solo project; you type along or you watch. It is a good two hours if you already know HTML and CSS and want to see how an experienced CSS teacher structures a real site with BEM class names, custom properties, Grid and Flexbox. It is not a course for learning those things from scratch, and the deploy section is a 2020 recording of DigitalOcean's dashboard.
...
Two caveats. First, this is a 2020 recording. Kevin mentions that "flexbox gap is coming. It's in Firefox, but it's not in the other ones yet," and the DigitalOcean lessons are slides of a dashboard that has since been redesigned. Second, the deploy method (rent a Linux server, upload files with FileZilla) is heavier than a static site needs in 2026. Nothing in the build depends on it, so you can just as easily push the folder to Netlify or GitHub Pages.
...
<Screenshot
  ...
  alt="Scrimba Build and Deploy Your Portfolio lesson The portfolio, paused with the preview open over the blurred editor: a dark My work section with the subtitle A selection of my range of work and a three-column grid of laptop photos"
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Scrimba Build and Deploy Your Portfolio lesson Adding the JS, paused with the preview showing the full-screen dark navigation panel open, four white links Home, My Services, About me and My Work, and the hamburger turned into a green X in the top right"
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Scrimba Build and Deploy Your Portfolio lesson Customizing your page, paused with the preview open: the intro section now uses a serif font and a red accent bar reading front-end dev next to the Jane Smith photo, and the What I do heading below is red"
  width={1400}
  height={660}
