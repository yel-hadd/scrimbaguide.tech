...
It fits frontend developers who can write JavaScript and are ready to see the server side of the requests they have only ever sent. It is also a good first backend course for [career changers](/docs/for/busy-professionals/) with limited time, because the scrims are short and nothing needs installing.
...
<CourseSchema
  ...
  instructor="Tom Chant"
  instructorUrl="https://scrimba.com/@DoubleNemesis"
  imageUrl="https://scrimbaguide.tech/img/scrimba/learn-nodejs/chapter-1-build-a-rest-api-title-card.webp"
/>
