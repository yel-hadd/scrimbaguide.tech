...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Serve Stringified JSON at 3:01: an await left off line 7, the first of the two errors most learners hit here."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Filter by Query Parameters at 4:46. The response comes back empty even though Asia has open destinations in the data, and JSON.parse fixes it a minute later."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 4:36 of Handling POST part 2, the addNewSighting function on the left reads the existing data, pushes in the new sighting, and writes the file back with fs.writeFile."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="sanitizeInput at 0:43. The button came from story.md, and the rest of the scrim is yours: write the utility that keeps it from happening again."
/>
