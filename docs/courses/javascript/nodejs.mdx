...
<Screenshot
  ...
  alt="Title card of the first project in Scrimba's Learn Node.js course: Build a REST API, The Wild Horizons API, teacher Tom Chant."
  width={1376}
  height={772}
...
<Screenshot
  ...
  alt="Title card of the second project in Scrimba's Learn Node.js course: Build a Routed Site, From the Other Side, with a ghost emoji."
  width={1376}
  height={772}
