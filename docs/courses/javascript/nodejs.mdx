...
<Screenshot
  ...
  width={1376}
  height={772}
  caption="Twenty scrims build a JSON API by hand, from a bare http.createServer to path parameters, query strings and CORS headers."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn Node.js, Serve Stringified JSON lesson: the network panel shows an empty response caused by a missing await."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn Node.js, Filter by Query Parameters lesson: the terminal highlights a boolean and a string that look equal but are not."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1376}
  height={772}
  caption="Twenty-seven scrims serve static files, parse and sanitize a POST body, then stream server-sent events for a ghost-sighting site."
...
<Screenshot
  ...
  alt="Learn Node.js, Handling POST lesson: a browser preview shows the sighting upload form beside the story being submitted."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn Node.js, sanitizeInput lesson: an unsanitized story renders a real clickable button inside the sightings page."
  width={1400}
  height={660}
