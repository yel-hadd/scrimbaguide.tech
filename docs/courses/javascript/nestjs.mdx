...
This course is free, with no subscription required. Scrimba Pro is a separate decision that unlocks the career paths, coding challenges, the private Discord, and certificates. See [current plans](https://scrimba.com/our-pricing) if you later want the path structure around it.
