...
<Screenshot
  ...
  alt="Learn Firebase, onSnapshot lesson: a code editor beside a console showing a type error message."
  width={1400}
  height={684}
...
<Screenshot
  ...
  alt="Learn Firebase, Security Rules lesson: a rules file beside a console showing a permission denied error."
  width={1400}
  height={684}
