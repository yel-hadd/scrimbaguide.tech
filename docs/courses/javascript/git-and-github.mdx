...
Scrimba's Pro course on version control, taught by Gregor Thomson in 40 short screencasts that add up to about 103 minutes. I watched all 40 scrims with a Pro account in September 2026, with the transcript panel open, and went back to the course page to check the table of contents for this write-up. This page is what is in there, including one thing the listing does not tell you: from lesson 14 onward you are working in your own terminal, not Scrimba's.

*This page is part of our [Scrimba JavaScript courses](/docs/courses/javascript/) catalog. Scrimba's course page shows no path badge, but the same material is the Git & Github module of the [Backend Developer Path](/docs/paths/backend-developer-path/).*

## Quick answer

Learn Git and GitHub is a 103 minute, Pro-only course rated Intermediate. The first four scrims are free samples. A scrim is Scrimba's name for one lesson: normally a recording you can pause and type into, but not here. In this course the editor pane holds nothing to type into, and the practice happens on your own computer with your own projects.

By the end you can put a project on GitHub three different ways (the website, GitHub Desktop, and the terminal), work on a branch, open and review a pull request, and fix a merge conflict without panic. You will also have met fetch, stash, revert, reset and rebase, at least once each.

There are no modules in the Scrimba sense, just a flat list of 40 scrims, but the course's own intro scrims split it into six sections plus a two-scrim wrap-up:

- **Intro**: what version control is, then uploading a project through GitHub's website
- **Coding locally**: GitHub Desktop and VS Code's source control panel
- **Become a Git Pro**: the terminal (init, add, commit, diff, push, branches)
- **Collaboration**: pull requests, code reviews, merge conflicts
- **Gits and Pieces**: fetch, log, stash, revert, reset, rebase
- **Other GitHub features**: profiles, stars, forks, issues, projects
...
<div className="screenshot-grid">
  <Screenshot
    ...
    alt="Title card of Scrimba's Learn Git and GitHub course: Git and GitHub, version control for your projects, teacher Gregor Thomson, on an orange and purple gradient with hexagon outlines"
    width={1318}
    height={741}
    caption="The course title card, which opens the intro and each section intro."
    source=""
  />
  <Screenshot
    src="/img/scrimba/learn-git-and-github/chapter-2-coding-locally-title-card.webp"
    alt="Expectations slide from the Coding locally section of Scrimba's Learn Git and GitHub course, listing GitHub Desktop as GitHub's dedicated application for source control and VS Code's source control panel for staging, committing and pushing"
    width={1318}
    height={741}
    caption="Section 2, Coding locally: the expectations slide from its intro scrim."
    source=""
  />
  <Screenshot
    src="/img/scrimba/learn-git-and-github/chapter-4-collaboration-title-card.webp"
    alt="Slide from the Collaboration intro of Scrimba's Learn Git and GitHub course: Git and GitHub help us to work seamlessly with other developers, listing branching, code reviews and merge conflicts"
    width={1318}
    height={741}
    caption="Section 4, Collaboration: branching, code reviews, merge conflicts."
...
<Screenshot
  ...
  alt="Scrimba Learn Git and GitHub lesson Git Workflow paused on a slide titled Push changes, with a diagram of two commits on a main branch and a yellow commit on a feature branch with an arrow pointing back toward main"
  width={1400}
  height={635}
...
<Screenshot
  ...
  alt="Scrimba Learn Git and GitHub lesson Source Control in VS Code paused at 1:51: a recorded VS Code window shows the Source Control panel with a commit message and one changed file, a side by side diff of index.html with a new projects section highlighted in green, and a commit graph below"
  width={1400}
  height={635}
...
<Screenshot
  ...
  alt="Slide from the Become a Git Pro intro in Scrimba's Learn Git and GitHub course with a warning icon and the text: in these lessons, we'll work on our own device; Scrimba's terminal does not support installing Git"
  width={1318}
  height={741}
...
<Screenshot
  ...
  alt="Scrimba Learn Git and GitHub lesson Merge Conflicts paused at 3:05: a recorded VS Code window shows index.html with a green Current Change block containing the team section under a HEAD marker, a blue Incoming Change block with a contact details section, and a Resolve in Merge Editor button"
  width={1076}
  height={605}
