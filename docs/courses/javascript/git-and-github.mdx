...
<Screenshot
  ...
  width={1400}
  height={635}
  caption="The Git Workflow lesson at 3:30. The rest of this section just redraws this same diagram in GitHub Desktop and VS Code."
/>
...
<Screenshot
  ...
  width={1400}
  height={635}
  caption="At 1:51 of Source Control in VS Code, right after the 'no staged changes to commit' warning, Scrimba's own file panel still holds only package-lock.json."
/>
...
<Screenshot
  ...
  width={1076}
  height={605}
  caption="Merge Conflicts at 3:05. This is real VS Code, not a diagram, and the conflict is one Gregor engineered a lesson earlier from a second GitHub account."
/>
