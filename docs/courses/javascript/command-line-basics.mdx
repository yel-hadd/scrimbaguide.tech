...
<Screenshot
  ...
  alt="Title card of Scrimba's Command Line Basics course: the name and teacher Ajo Borgvold on an orange and purple gradient."
  width={1377}
  height={775}
...
<Screenshot
  ...
  alt="Title card of section two of Scrimba's Command Line Basics course: Command Line Basics pt. 2, teacher Ajo Borgvold."
  width={1377}
  height={775}
