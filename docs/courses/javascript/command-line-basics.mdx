...
<Screenshot
  ...
  width={1377}
  height={775}
  caption="Ten scrims drill pwd, ls, cd, touch, rm and mkdir through seven graded challenges that sort a fictional startup's file system."
  source=""
/>
...
<Screenshot
  ...
  alt="Command Line Basics, Creating and Deleting Directories lesson: the terminal shows an error after rmdir fails on a full folder."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Command Line Basics, Reading from Files lesson: the terminal prints a merged team list after the challenge solution runs."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1377}
  height={775}
  caption="Thirteen slide-based scrims cover find, grep, sed, mv, cp, wc, sort, uniq and the pipe, with no challenges inside Scrimba."
...
<Screenshot
  ...
  alt="Command Line Basics, Combining Commands with the Pipe lesson: an annotated slide of a real terminal shows duplicates removed."
  width={1400}
  height={660}
