...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Creating and Deleting Directories at 3:02. Ajo runs rmdir on the family_photos_1988 folder first, hits ENOTEMPTY, then switches to rm -r."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 5:09 of 'Reading from Files: cat', three external people are appended to team_members.txt with cat and >>."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="A pink circle at 2:21 of Combining Commands with the Pipe marks the pipe itself, the seam between sort and uniq the lesson is built around."
/>
...
This is a tooling course rather than a language course. It sits before [Learn Git and GitHub](/docs/courses/javascript/git-and-github/) (which lives in the terminal from its third section) and before [Learn Node.js](/docs/courses/javascript/nodejs/), where you start running your own code from a command line. The [Backend Developer Path](/docs/paths/backend-developer-path/) draws on part of this course for its own 103 minute "Command Line Interface" module, and Ajo's teacher card mentions work on that path, so backend learners are the intended audience. Frontend learners can take it any time; it does not depend on [Learn JavaScript](/docs/courses/javascript/learn-javascript/).
...
- [Backend Developer Path](/docs/paths/backend-developer-path/), which draws on part of this course for its own module
