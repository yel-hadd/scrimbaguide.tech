...
Dylan C. Israel's one-hour Pro course on making JavaScript readable: better variable names, smaller functions, and far fewer comments. I opened all 26 scrims and read the transcript of every one with a Pro account in September 2026, so this page describes what is in the course, not what the listing promises.

*This page is part of our [Scrimba JavaScript courses](/docs/courses/javascript/) catalog. Scrimba's course page does not list it under any career path; it is a standalone skills course.*

## Quick answer

Introduction to Clean Code is a 64 minute, intermediate, Pro-only course taught by Dylan C. Israel. It is 26 short scrims in a flat list (no modules), split between explanation and seven small refactoring challenges where you rename, extract, and delete things in a file of a dozen lines. The first five scrims are free previews. There is no project; you leave with a set of habits and one honest final assignment, which is to go back and clean up your own old repositories.

It is worth an hour if you can write working JavaScript but nobody has ever reviewed your code. It is not worth a subscription on its own, and it will feel thin if you already work on a team with code reviews.
...
<div className="screenshot-grid">
  <Screenshot
    ...
    alt="Title slide of Scrimba's Introduction to Clean Code course: Code Like a Pro, Clean Code Introduction, by Dylan C. Israel, with a circuit-board photo and a portrait of the instructor painted as a nineteenth-century general"
    width={1279}
    height={720}
    caption="The course intro slide. The portrait is Dylan's own running joke."
    source=""
  />
  <Screenshot
    src="/img/scrimba/introduction-to-clean-code/chapter-3-clean-functions-title-card.webp"
    alt="Title slide of the Clean Functions section of Scrimba's Introduction to Clean Code course: Code Like a Pro: Functions, by Dylan C. Israel, white text on blue"
    width={1279}
    height={720}
    caption="The Clean Functions section opener. Each section starts with a slide like this before the code scrims."
...
<Screenshot
  ...
  alt="Scrimba's Clean Functions: Encapsulating Conditionals scrim paused at 3:08: index.js shows getNonPrimaryUsers calling a new getIsUserPrimaryActiveAccount function, which stores isPrimaryAccount and isActive in named constants and returns isActive && isPrimaryAccount"
  width={1400}
  height={684}
...
What it does well: the before-and-after format makes each rule concrete, the challenges are short enough that you will do them rather than skip them, Dylan is honest about his own unreadable code, and the free previews cover the most useful section.
...
<AffiliateLink href="https://scrimba.com/introduction-to-clean-code-c025" variant="button">
  Preview Introduction to Clean Code on Scrimba
</AffiliateLink>
