...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="The Merge Sort lesson at 6:34. The recursion has just bottomed out at a one-element list, the [2] highlighted in yellow, with everything above it still waiting to merge."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Imperative, paused at 2:03, right where Jonathan says to pause and make the test pass: expected [1, 2], got [2, 1]. Every implementation lesson starts here."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Queue, paused at 6:22, just before he saves. Gone completely from the imperative version: the for loop, and the i, j and k counters it needed."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The clever parts from Cursor, ArrayView and lodash.times are pushed down into merge and the wrapper by the time Simple pauses at 6:21, leaving mergesortSimple just to call them."
/>
