...
This is the second course in Jonathan Lee Martin's algorithm series on Scrimba, after [Binary Search](/docs/courses/javascript/data-structures-and-algorithms-binary-search/). The intro and the wrap up both call it a series with "more on the way," but Scrimba's catalog data lists only these two courses under his name as of September 2026. Scrimba's catalog data does not put this course on any career path. The natural order is the broad [Data Structures and Algorithms](/docs/courses/javascript/data-structures-and-algorithms/) course for coverage, since that one is part of the [Backend Developer Path](/docs/paths/backend-developer-path/), then Binary Search, then this, then [JavaScript Interview Challenges](/docs/courses/javascript/javascript-interview-challenges/) to apply it under time pressure.
