...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 0:00 of Imperative, this is the state you pause on: get the console quiet before you continue."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Recursion at 5:57. With no base case yet, the first save blows the call stack; Jonathan reads the error and adds the guard inside thirty seconds."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 3:17 of Array View, the challenge brief, slice and get still have to satisfy the no-copy rule Jonathan just stated, and the tests live in the same binary-search.test.js."
/>
