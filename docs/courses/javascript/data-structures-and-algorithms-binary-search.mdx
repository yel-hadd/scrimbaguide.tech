...
*This page is part of our [Scrimba JavaScript courses](/docs/courses/javascript/) catalog. Scrimba's catalog data does not list it under a career path.*
...
Scrimba's catalog data does not put the course on any career path. It pairs with the same instructor's [Merge Sort](/docs/courses/javascript/data-structures-and-algorithms-merge-sort/) course, which uses the same challenge-then-solution format on a sorting algorithm. Take the broad [Data Structures and Algorithms](/docs/courses/javascript/data-structures-and-algorithms/) course first if you want the vocabulary, since that one is part of the [Backend Developer Path](/docs/paths/backend-developer-path/), and [JavaScript Interview Challenges](/docs/courses/javascript/javascript-interview-challenges/) afterwards if the goal is interviews.
