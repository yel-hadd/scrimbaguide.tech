...
Scrimba's Pro course on data structures and algorithms, taught by Shant Dashjian in about two and a half hours, with a running story about saving the dinosaurs. I read the transcript of every one of its 35 scrims with a Pro account in September 2026, so this page describes what is in the course rather than what the listing says.
...
Data Structures and Algorithms is a short, code-first introduction to the topic in JavaScript: Big O notation, arrays, strings, bubble sort, merge sort, recursion, linear and binary search, maps, stacks, queues, linked lists, binary search trees, depth-first and breadth-first search, and graphs. Scrimba lists it at 2.5 hours, Advanced, Pro only. I counted 35 scrims, 11 of them titled challenges where you write a function and run `npm test` against a prepared Vitest file, plus nine shorter "do it right now" pauses inside the teaching scrims. Every challenge is framed as a problem for a fictional dinosaur social network. It is a good first pass at the subject for a self-taught developer, and a thin one for anyone who already knows what a hash map is.
...
<div className="screenshot-grid">
  <Screenshot
    ...
    alt="Title card of Scrimba's Data Structures and Algorithms course on a purple and gold gradient, reading Scrimba Course, Data Structures and Algorithms, Teacher: Shant Dashjian"
    width={1378}
    height={775}
    caption="The course title card that opens the Welcome scrim."
    source=""
  />
  <Screenshot
    src="/img/scrimba/data-structures-and-algorithms/chapter-big-o-notation-title-card.webp"
    alt="Title slide of the Big O Notation lesson in Scrimba's Data Structures and Algorithms course, reading Understand Big O Notation with three floating cubes"
    width={1378}
    height={775}
    caption="Lesson 3, Big O Notation: the first slide."
    source=""
  />
  <Screenshot
    ...
    width={1378}
    height={775}
    caption="Lesson 30, Graphs: the last data structure in the course."
...
The honest caveat is depth. The course runs about two and a half hours and Shant calls it "Scrimba's introduction to data structures and algorithms" in the closing scrim. There is no heap, no hash table internals, no dynamic programming, no Dijkstra, and the tree lesson says outright that it covers "a subset of the most important parts". If you are preparing for interviews at companies that ask hard algorithm questions, this is the vocabulary lesson, not the practice. The two narrower courses by Jonathan Lee Martin, [Binary Search](/docs/courses/javascript/data-structures-and-algorithms-binary-search/) and [Merge Sort](/docs/courses/javascript/data-structures-and-algorithms-merge-sort/), go deeper on single algorithms.
...
<Screenshot
  ...
  alt="Scrimba Data Structures and Algorithms lesson Challenge: Dinosaur Age Range paused at 1:52, showing the challenge.md file with the constraint ages.length >= 1 and four numbered tasks: write the algorithm in plain English, implement getAgeRange in JavaScript, run npm test, and write down the time and space complexity in Big O notation"
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Scrimba Data Structures and Algorithms lesson Challenge: Tag Sum Lottery paused at 5:26, showing the finished tagSumLottery function in the editor: a single for loop that computes the difference between the lottery number and each tag, checks a Map called tagName, and pushes sorted name pairs into a winners array, with the numbered plain-English steps in a comment above it"
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Scrimba Data Structures and Algorithms lesson Challenge: Are They Connected? at 0:00, showing a slide of the dinosaur social network as a graph: Eddie, Brie, Tim, Vinnie and Sam form one connected cluster with a cycle, while Lori, Maddie, Amber and Cassie form a second cluster with no edge to the first"
  width={1400}
  height={660}
