...
*This page is part of our [Scrimba JavaScript courses](/docs/courses/javascript/) catalog. Scrimba's catalog data lists it under the [Backend Developer Path](/docs/paths/backend-developer-path/), and the welcome lesson addresses learners "taking this course as part of Scrimba's backend developer path".*
