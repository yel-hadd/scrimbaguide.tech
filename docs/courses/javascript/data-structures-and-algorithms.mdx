...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 1:52 of the Dinosaur Age Range challenge, this is the shape every later challenge repeats: plain English steps, then code, then npm test against getAgeRange.test.js, then a Big O writeup."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Tag Sum Lottery at 5:26. The inner loop from the starting version is gone: one pass, one Map, O(n), the pattern this course wants you to leave with."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Eddie reaches Sam through Vinnie, but not Amber, in 'Are They Connected?' at 0:00; the Eddie, Brie, Tim, Vinnie loop is exactly the cycle a visited set has to catch."
/>
