...
Learn Next.js is Scrimba's free, intermediate Next.js course: about 8.5 hours across three sections, taught by Bob Ziroll for the first two and Rachel Johnson for the third. You build PrintForge, a site where 3D printing enthusiasts browse models, first as static pages with the App Router, then with a SQLite database, search, sort, and pagination driven by the URL. Take it once you know React; plan to do six early challenges in a local editor, since those no longer run inside Scrimba.
