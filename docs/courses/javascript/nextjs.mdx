...
Scrimba's free Next.js course, about 8.5 hours long, builds one project from a blank folder to a catalog backed by a database with search, sorting, and pagination. I opened every section and worked through a sample of lessons from each one with a Pro account in September 2026. Two things the listing does not tell you: the third section has a different teacher, and six scrims near the start no longer run inside Scrimba.

*This page is part of our [Scrimba JavaScript courses](/docs/courses/javascript/) catalog. Scrimba's course page lists it under both the [Frontend Developer Path](/docs/paths/frontend-developer-path/) and the [Fullstack Developer Path](/docs/paths/fullstack-developer-path/).*

## Quick answer

Learn Next.js is Scrimba's free, intermediate Next.js course: about 8.5 hours across three sections, 123 scrims by my count, taught by Bob Ziroll for the first two sections and Rachel Johnson for the third. You build PrintForge, a site where 3D printing enthusiasts browse models, first as static pages with the App Router, then with a SQLite database, a data layer, and search, sort, and pagination driven by the URL. It runs Next 15.2.4 on React 19 with TypeScript and Tailwind. It assumes you already know React. If you do, and you keep being told to learn Next.js next, this is the course to take; just plan to do six of the early challenges in a local editor.
...
<div className="screenshot-grid">
  <Screenshot
    ...
    alt="Slide from the introduction of Scrimba's Learn Next.js course titled PrintForge, showing mobile and desktop mockups of the home page and the 3D models catalog you build"
    width={1377}
    height={775}
    caption="Section 1 intro: PrintForge, the one project the whole course builds."
    source=""
  />
  <Screenshot
    ...
    width={1377}
    height={775}
    caption="Section 2: the rendering strategies lessons, the most slide-heavy part."
    source=""
  />
  <Screenshot
    ...
    width={1377}
    height={775}
    caption="Section 3: Making Data Flow, where Rachel Johnson takes over."
...
<Screenshot
  ...
  alt="Scrimba Learn Next.js lesson Challenge, PrintForge Home Page paused at 0:09: a slide over the editor shows the Figma design of the home page on mobile and desktop, with the heading Discover what's possible with 3D printing, a Browse Models button and a hero image, while the file explorer on the left lists the app folder, layout.tsx and page.tsx"
  width={1400}
  height={656}
...
<Screenshot
  ...
  alt="Scrimba Learn Next.js lesson Rendering Strategies Intro paused at 6:59: a slide titled Rendering Strategies shows a table with rows for Static Site Generation, Incremental Static Regeneration and Server-side Rendering, columns for when and where each is rendered, and the note depending on your code"
  width={1400}
  height={656}
  caption="The summary table at 6:59. Notice that every row says on server: Bob's point is that Next.js renders routes on the server by default and the strategy only changes when."
/>
...
<Screenshot
  ...
  alt="Scrimba Learn Next.js lesson Final Pagination Challenge paused at 4:49: the editor shows PaginationButton.tsx with usePathname, useRouter and useSearchParams, a handlePageChange function that sets the page param and pushes the URL, and a button rendering label or page; the preview on the right shows the PrintForge catalog at /3d-models?page=12 with pagination buttons for previous, 11, 12, 13 and next, and the Runner logs GET requests"
  width={1400}
  height={656}
  caption="The solution at 4:49 of the final challenge: a label prop turns the first and last buttons into arrows, and the preview shows page 12 of the catalog. The Runner log underneath is the real Next.js dev server responding to each click."
/>
...
Learn Next.js is the Next.js module of the [Fullstack Developer Path](/docs/paths/fullstack-developer-path/), where it sits after the React, Node, Express, SQL, and TypeScript blocks, and it is the bridge from frontend React into fullstack work. Do [Learn React](/docs/courses/react/learn-react/) first. If section 3's SQL was the part you liked, [Learn SQL](/docs/courses/backend/sql/) goes deeper. If you would rather build the server yourself, [Learn Express.js](/docs/courses/javascript/expressjs/) and [Learn Node.js](/docs/courses/javascript/nodejs/) are the alternatives. For the type annotations you will see throughout, [Learn TypeScript](/docs/courses/typescript/learn-typescript/).
