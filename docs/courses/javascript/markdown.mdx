...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Three scrims cover what Markdown is, set the dev.to article as the project, and explain the README boilerplate you never touch."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn Markdown, 2nd Paragraph challenge: a split editor and preview showing bold, struck-through and italic text."
  width={1400}
  height={633}
...
<Screenshot
  ...
  alt="Learn Markdown, About Yourself challenge: a split editor and preview of an About Me section with an image link."
  width={1400}
  height={633}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Four scrims cover tables, task lists and automatic URLs, and warn that support for each varies between GitHub and dev.to."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn Markdown, Extended Syntax Tables lesson: a split editor and preview of a three column aligned table."
  width={1400}
  height={633}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="The final challenge publishes the dev.to article, then clones the student repo, adds a link to the README, and opens a pull request."
