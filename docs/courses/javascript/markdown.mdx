...
<Screenshot
  ...
  width={1400}
  height={633}
  caption="Challenge: 2nd Paragraph at 0:47. The brief is the four numbered steps inside the README, and there is no grader here: the rendered result on the right is the only check your answer gets."
/>
...
<Screenshot
  ...
  width={1400}
  height={633}
  caption="At 2:16 of the About Yourself challenge, line 9 nests an image inside a link, the one construction in the whole course that trips people up."
/>
