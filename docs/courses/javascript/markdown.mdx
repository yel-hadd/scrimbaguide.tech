...
<Screenshot
  ...
  alt="Title slide of Scrimba's Learn Markdown course: Course Overview and Setup, teacher Dylan Israel, on pale green and lilac."
  width={1279}
  height={720}
...
<Screenshot
  ...
  alt="Slide from Scrimba's Learn Markdown course: the Markdown logo above links to the basic and extended syntax guides."
  width={1279}
  height={720}
