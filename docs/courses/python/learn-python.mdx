...
<Provenance subject="course" date={frontMatter.reviewed} detail="all 61 scrims read from transcript" />
...
<Screenshot
  ...
  width={1280}
  height={712}
  caption="This module covers variables, f-strings and type conversion while building PayUp, an expense splitter that runs in the terminal."
  source=""
/>
...
<Screenshot
  ...
  width={1400}
  height={625}
  caption="The finished PayUp app running in the terminal, the target this module builds toward one concept at a time."
