...
The honest caveat is platform fit. Scrimba is overwhelmingly a JavaScript and web-development platform, and its Python catalog is still narrow by comparison. That said, the offering is stronger than it used to be: Scrimba now publishes free <AffiliateLink href="https://docs.scrimba.com/python/introduction" location="companion-docs">official Python documentation</AffiliateLink>, one section of a broader docs site that also covers HTML, CSS, JavaScript, and how AI works, that pairs with the course, adds adaptive depth, build-along projects, and a debugging section, and is being actively expanded. For genuinely deep Python specialization (data science, backend frameworks like Django, automation at scale) you will still move to a Python-first resource, but as a free on-ramp this is more self-contained than before.

## The companion docs

Alongside the interactive course, Scrimba has launched a free <AffiliateLink href="https://docs.scrimba.com/python/introduction" location="companion-docs">documentation site</AffiliateLink> whose Python section reads as a textbook to the course's hands-on lessons (the same site now also covers HTML, CSS, JavaScript, and how AI works). Two things make the Python docs worth knowing about:
...
<FAQAccordion items={[
  ...
  { q: "Does Scrimba have official Python documentation?", a: "Yes. Scrimba publishes free docs at docs.scrimba.com with a full Python section that pairs with the course (the same site also covers HTML, CSS, JavaScript, and how AI works). The Python docs add a Beginner/Intermediate/Deep Dive level switcher that adjusts how deep each chapter goes, in-depth coverage of topics such as classes and modules, build-along projects, and a debugging section, and are being actively expanded." },
]} />
