...
This is a side branch off Scrimba's React track, not a step on it. It is not part of the [Frontend Developer Path](/docs/paths/frontend-developer-path/) or the [Fullstack Developer Path](/docs/paths/fullstack-developer-path/), and Bob describes it as an onboarding phase between [Learn React](/docs/courses/react/learn-react/) and [Advanced React](/docs/courses/react/advanced-react/). Take it right before [Advanced React](/docs/courses/react/advanced-react/), or the week you inherit a legacy codebase.
