...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The counter challenge at 0:18: a numbered brief in a comment, the working hooks version below it, and the recording paused until you convert it."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 5:16, the componentDidMount challenge is solved: the second render fires from setState once the fetch resolves, and componentDidMount itself never runs again."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="setState inside componentDidUpdate keeps triggering another update, the infinite loop at 2:28, until Bob comments the line out and introduces prevState."
/>
