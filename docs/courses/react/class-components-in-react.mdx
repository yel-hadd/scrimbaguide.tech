...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="This module reviews ES6 classes in five minutes, converts a one-line function component to a class, then hands you the first challenge: convert three components and find the missing prop."
