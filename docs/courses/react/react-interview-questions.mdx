...
<Provenance subject="course" date={frontMatter.reviewed} detail="every scrim transcript read, the coding exercise worked through" />
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="A free preview: Cassidy sets the format, drilling what you already know rather than teaching new React."
  source=""
/>
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="A free preview covering two questions: virtual DOM versus real DOM, and virtual DOM versus shadow DOM."
  source=""
/>
...
<Screenshot
  ...
  alt="React Interview Questions, The Virtual DOM lesson: a slide with a two-column table comparing the virtual and real DOM."
  width={1045}
  height={588}
...
<Screenshot
  ...
  alt="React Interview Questions, JSX lesson: code editor showing a component built without JSX syntax."
  width={1400}
  height={690}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Five quick definitions, then the course's only coding task: converting a class-based counter to useState."
...
<Screenshot
  ...
  alt="React Interview Questions, Miscellaneous questions lesson: code editor showing a class-based counter component beside its preview."
  width={1400}
  height={690}
