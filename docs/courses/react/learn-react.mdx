...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The AI challenge solution at 6:59. This is the real response from the Claude API, not a mock: 'we're going to format it in a really easy way using a third party package.'"
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 1:35 of the capstone intro, App.jsx is complete: a lazy useState initializer, a derived gameWon value, and a useEffect that focuses the button when you win."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The JSX on the left is the end state of the component you build across this section, three wrong guesses into the 0:38 demo with HTML, CSS and JavaScript already gone."
/>
