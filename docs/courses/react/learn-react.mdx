...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Fifty-eight scrims build useState, forms, and conditional rendering, then wire the Chef Claude form to the Claude API."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn React, Chef Claude lesson: a code editor beside a preview showing an AI recipe rendered as raw markdown."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Nineteen scrims build the Tenzies dice game, from the Die component to lazy state and two accessibility passes."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn React, Tenzies capstone lesson: a code editor beside a dice game preview with nine dice held on the same number."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Twenty-eight scrims build the Assembly: Endgame hangman game, from the keyboard to farewell messages and a reset."
...
<Screenshot
  ...
  alt="Learn React, Assembly Endgame lesson: a code editor beside a hangman style game with a partly guessed word and keyboard."
  width={1400}
  height={660}
