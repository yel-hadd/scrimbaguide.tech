...
<Screenshot
  ...
  alt="What's New in React 19, useTransition lesson: the preview shows a Loading message while a slow tab switch is pending."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="What's New in React 19, useActionState Part 2 challenge: a comment brief asks for a loading message during the action."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="What's New in React 19, useActionState Part 3 lesson: the form shows a red error message after a failed update."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="What's New in React 19, use() lesson: the preview is blank and the console shows a Suspense related client error."
  width={1400}
  height={660}
