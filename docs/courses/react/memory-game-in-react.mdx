...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Fetch data from API at 4:22. Ajo mistypes reponse on line 18 while narrating the solution, and the console throws ReferenceError before the fix a few seconds later."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The not-allowed cursor, at 8:42 of the Conditional lesson, comes from a chained ternary that swaps classes once a pair is matched, the technique Ajo says a plain if/else could replace just as well."
/>
...
<Screenshot
  ...
  alt="Slide from Scrimba's Build a Memory Game in React course: aria-label and aria-live make elements accessible to screen readers."
  width={1279}
  height={720}
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The final challenge, solved at 7:57, ends in a game over screen with all ten cards matched and greyed. The GameOver box gets focus so a screen reader announces it, and one Tab reaches Play again."
/>
