...
Pro also unlocks the certificate and the Pro-only Discord channels. Basic Discord access is on the free plan according to <AffiliateLink href="https://scrimba.com/our-pricing">Scrimba's pricing page</AffiliateLink>, so the community itself is not the upgrade reason; this course is.
