...
<Provenance subject="course" date={frontMatter.reviewed} detail="every module opened, transcripts read for 26 of the 43 scrims, including the intro, outro and each module's first lesson" />
...
<Screenshot
  ...
  alt="Build a Memory Game in React, Fetch data from API lesson: code editor beside a console reference error."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Build a Memory Game in React, Duplicate and shuffle emojis lesson: preview showing ten face-up emoji cards."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Build a Memory Game in React, Conditional memory card styling lesson: preview showing a greyed-out matched card pair."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="This aside explains aria-label and aria-live, and why each card needs a label instead of relying on its HTML entity code for its accessible name."
  source=""
/>
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="This 10:26 aside covers useRef, useEffect, .focus(), and tabIndex, the four tools that move focus to a new element so a screen reader announces it."
...
<Screenshot
  ...
  alt="Build a Memory Game in React, final lesson: preview showing the game-over screen with a Play again button."
  width={1400}
  height={660}
