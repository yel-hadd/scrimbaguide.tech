...
<Screenshot
  ...
  alt="Learn React Router, Vans Page challenge: a code editor beside a preview listing van rental cards."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="23 scrims build three levels of nested navigation for VanLife's host section, fixing the broken relative paths with a layout route and an index route."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn React Router, Host Layout lesson: a code editor beside a preview showing the nested host nav bar."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn React Router, Happy Path vs Sad Path: a blank preview beside a console showing a crash error."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="13 scrims swap the useEffect fetch for a route loader and useLoaderData, then add errorElement and useRouteError for error handling."
  source=""
/>
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="40 scrims build protected routes with a requireAuth loader check, then replace controlled form state with React Router's Form, actions, and useNavigation."
...
<Screenshot
  ...
  alt="Learn React Router, redirectTo lesson: a code editor beside a sign-in form preview with a redirect message."
  width={1400}
  height={660}
