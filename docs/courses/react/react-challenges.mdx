...
Scrimba's Pro practice course for people who already know React: 40 problems, each with a brief and a recorded solution, taught by Daniel Rose across 9.8 hours. I opened 49 of the 84 scrims with a Pro account in September 2026: every one of the 40 challenge briefs, seven of the solution walkthroughs, the intro and the outro. I read the code and transcripts in each.
...
React Challenges is a Pro, intermediate course built from 40 small apps that are each broken or unfinished in one specific way. You get a comment block at the top of `App.jsx` describing what to fix and a few hint files in the explorer. Then comes a solution scrim where Daniel Rose builds it and explains his reasoning. The briefs add up to 2.7 hours of video; the solutions are the other 6.9 hours, and 17 of them run past ten minutes. It uses React 18.2 throughout, function components and hooks only. If you have finished [Learn React](/docs/courses/react/learn-react/) and want to find out what you can build without a walkthrough, this is the course to do next. If you have not, the briefs will read as a wall.
...
The other caveat is that it teaches nothing in order. Forms come up in challenge 4, again in 13, again in 24 and 37. If you want a syllabus, this is the wrong course. If you want to be surprised by what you cannot do yet, it is the right one.
...
What it does well: the briefs are specific and honest about scope (most say you only need to write code below the comments), and the projects are more fun than they need to be. The hint files give you a middle option between struggling and watching, and the long solutions explain mutation, references and intervals rather than just showing the answer.
