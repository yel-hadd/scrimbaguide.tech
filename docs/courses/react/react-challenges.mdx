...
<Provenance subject="course" date={frontMatter.reviewed} detail="every one of the 40 challenge briefs, seven of the solution walkthroughs, the intro and the outro" />
...
<Screenshot
  ...
  alt="React Challenges, Space Warrior challenge: a preview of a pixel-art arcade game start screen with a Play button."
  width={668}
  height={628}
  narrow
...
<Screenshot
  ...
  alt="React Challenges, Video Game Button challenge: a code editor showing a numbered brief with a diagram of a toggle button."
  width={1400}
  height={605}
...
<div className="screenshot-grid">
  <Screenshot
    ...
    alt="React Challenges, Pookemon challenge: a preview of a Game Boy style game with a character in a stone prison room."
    width={302}
    height={564}
    narrow
  ...
  <Screenshot
    ...
    alt="React Challenges, Scrimbatronic challenge: a preview of a synthesizer panel with instrument buttons and a keyboard."
    width={526}
    height={427}
...
This is a Pro course. Two scrims carry the SAMPLE badge and open without a subscription: the intro and the Video Game Button challenge brief. Everything from the first solution onward is Pro. So is the Certificate of Completion at the end of the list. Scrimba's pricing page lists basic Discord access under the free plan and the Pro-only channels under Pro, so the community is not something you are buying here. See <AffiliateLink href="https://scrimba.com/our-pricing">current plans</AffiliateLink> for what Pro costs in your region.
...
React Challenges is not part of any career path; it stands alone as a practice course. Take it straight after [Learn React](/docs/courses/react/learn-react/). Daniel's own recommendation in the outro is [Advanced React](/docs/courses/react/advanced-react/) and [React Router](/docs/courses/react/react-router/) next. "They are how I learned React myself." For interview drilling of the question-and-answer kind, pair it with [React Interview Questions](/docs/courses/react/react-interview-questions/).
...
<FAQAccordion items={[
  { q: "Is React Challenges free on Scrimba?", a: "No. It is a Pro course. Two scrims are free previews (the intro and the first challenge brief, Video Game Button); the other 82 and the certificate need a subscription. Learn React, the prerequisite, is free." },
