...
<FAQAccordion items={[
  ...
  { q: "Do I need to take Learn React first?", a: "Effectively yes. The second scrim is a props review challenge, and Bob says that if it takes you more than a few minutes, you are probably not ready for this course. It assumes hooks, useEffect data fetching, map and filter, and async/await." },
...
<CourseSchema
  ...
  instructor="Bob Ziroll"
  instructorUrl="https://scrimba.com/@bobziroll"
  imageUrl="https://scrimbaguide.tech/img/scrimba/advanced-react/chapter-1-reusability-title-card.webp"
/>
