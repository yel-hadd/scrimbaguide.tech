...
<Provenance subject="course" date={frontMatter.reviewed} detail="every module opened, transcripts read for 86 of the 240 scrims, at least a third of each module" />
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Ten scrims build a Button, then a Menu, a headless Toggle, and custom hooks that replace it, ending in the Component Library++ solo project."
  source=""
/>
...
<Screenshot
  ...
  alt="Advanced React, Mega Challenge lesson: the preview shows one Avatar component rendering a photo, initials, and an icon."
  width={1400}
  height={625}
...
<Screenshot
  ...
  alt="Advanced React, Intro to Refs lesson: the preview shows a render counter spiraling out of control in an infinite loop."
  width={1400}
  height={625}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Eighty-six scrims build VanLife: nested routes, search params, protected routes, and a swap from a mock API to Firestore."
  source=""
/>
...
<Screenshot
  ...
  alt="Advanced React, VanLife lesson: the preview shows the van listing page with filter buttons above two van photos."
  width={1400}
  height={625}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Nineteen scrims cover rendering phases, code splitting with lazy and Suspense, React.memo, and useCallback."
  source=""
/>
...
<Screenshot
  ...
  width={1375}
  height={768}
  caption="Ten scrims build a Supabase sales dashboard: a deals table, a live bar chart, and a realtime subscription."
...
<Screenshot
  ...
  alt="Advanced React, Realtime subscription lesson: the preview shows a sales dashboard bar chart next to a running dev server."
  width={1400}
  height={625}
