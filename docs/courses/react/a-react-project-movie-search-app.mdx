...
<Screenshot
  ...
  alt="Movie Search App, Display Movie Information lesson: a results list shows movie details with poster images missing."
  width={1400}
  height={684}
...
<Screenshot
  ...
  alt="Movie Search App, Movie Card Component challenge: the code now renders movie cards with no console warnings left."
  width={1400}
  height={684}
