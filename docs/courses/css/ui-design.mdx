...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Seventeen scrims cover white space, alignment, contrast, scale, typography, color, and visual hierarchy on small standalone examples."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn UI Design, White Space lesson: two identical cards side by side, one cramped and one with generous spacing."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Nine scrims build Tasty Bites mobile-first, then add media queries and a grid-template-areas challenge for wider screens."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn UI Design, Desktop Media Query lesson: the refactored dashboard preview shows a sidebar and data panels at desktop width."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn UI Design, TeaPlace solution: the preview shows the finished tea shop landing page at desktop width."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Seven scrims build a three-step signup form with an error state, then swap the native radio buttons and checkboxes for custom ones."
  source=""
/>
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Fifteen scrims build the Scenic Forests cabin rental site and its sub page, ending in a GSAP entrance animation."
...
<Screenshot
  ...
  alt="Learn UI Design, final project lesson: the preview shows the Scenic Forests landing page with a forest photo hero and cabin cards."
  width={1400}
  height={660}
