...
Learn CSS Grid is a Pro, intermediate-level course of about 63 minutes, taught by Per Borgen, Scrimba's co-founder, across a five-scrim layout section, a three-scrim responsive section, five bonus scrims, and a wrap-up with the Pro solo project. The first three scrims are free samples. If you know basic CSS and want grid to click in an evening, this is the right hour; it is not a full CSS education and does not pretend to be.
