...
This is a short, standalone skill course, not attached to a Scrimba career path. Its pair is [Learn Flexbox](/docs/courses/css/flexbox/): grid for two-dimensional layout, flexbox for one direction, and the "Grid vs. Flexbox" scrim is where Per draws the line. If you take [Learn Responsive Web Design](/docs/courses/css/responsive-web-design/), you will meet grid again in a broader context. This course works either as a warm-up for it or as a quick refresher after it.
