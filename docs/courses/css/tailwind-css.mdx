...
This course stands outside Scrimba's four career paths; none of them include it. Take it after your core CSS and before you start a React or Next.js project that ships with Tailwind. The [product card course](/docs/courses/css/a-product-card-with-tailwind-css/) is the follow-up Rachel names in the outro, where "we dive into more intermediate utility classes."
