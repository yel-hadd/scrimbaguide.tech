...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Header and Footer's starter file, 0:23 in: the tasks are a comment at the top of index.html, and the preview is 'so raw that our preview looks pretty subpar,' Rachel says."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The middle button's hover state, hover:bg-cyan-300 hover:text-black, is caught at 7:41 of the pricing table solution; the three cards sit lg:w-1/3 in a lg:flex-row container."
/>
