...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 0:43 of the Adding custom colours challenge, the brief is three numbered comments at the top of the file, and the hex codes you need sit on the slide thumbnail, bottom left."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Styling the buttons, 5:30 in and just after the flex row gets its vertical margin: the whole lesson is that one line, the button's class list in the editor."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Mobile and desktop views at 4:18, after the save: five md: classes on the main element turn the stacked card into this two-column layout, and dragging the preview narrower stacks it again."
/>
