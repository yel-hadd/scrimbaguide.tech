...
This is a Pro course, so it needs a Scrimba subscription. Pro also covers the career paths, certificates, and Discord. See [current plans](https://scrimba.com/our-pricing) for what Pro costs in your region.
