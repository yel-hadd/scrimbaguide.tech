...
CSS Challenges is not part of any Scrimba career path. The natural order is a teaching course first ([Learn HTML and CSS](/docs/courses/css/html-and-css/), then [Learn Responsive Web Design](/docs/courses/css/responsive-web-design/)), this pack to harden it, and then the animation-heavy challenges point toward [Learn CSS Animations](/docs/courses/css/css-animations/). Treasure also teaches Scrimba's [JavaScript Interview Challenges](/docs/courses/javascript/javascript-interview-challenges/), which has the same brief-and-solution shape.
