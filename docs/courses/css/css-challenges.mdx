...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Colorful Button solution at 6:06. The flip is a second gradient at 230deg on the wrapper, not a reversed color list; font-family: inherit on the button undoes the browser's default font, the same fix the GitHub Profile Layout solution reuses."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="The stats row only appears on hover, so it stays out of frame at 5:44 of the CodePen Tile solution."
/>
