...
Scrimba's free beginner anchor, taught by Per Borgen: about 5.7 hours of short scrims in which you build and deploy five websites, then build a sixth on your own. I opened every module and worked through lessons from each with a Pro account in September 2026; this is what the course actually contains.

## Quick answer

Learn HTML and CSS is Scrimba's free, beginner-level course, made in partnership with MDN: roughly 5.7 hours across six modules and 115 scrims, taught by Per Borgen. You build a personal website, a Google.com clone, a digital business card, a space exploration landing page, and a birthday site with hover-reveal "gifts," deploying most of them to the web as you go, and you finish with a free solo project (a hometown homepage) built from a skeleton and a color palette. It assumes nothing. If you are new to web development, this is the single best place on the site to begin.
