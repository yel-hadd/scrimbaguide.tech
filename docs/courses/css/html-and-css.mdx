...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="CSS starts here: styling the Google clone leads into margins, divs, classes, and why flexbox exists."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn HTML and CSS, flexbox centering lesson: a code editor and preview of the Google clone with two buttons centered but touching."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn HTML and CSS, Space Exploration project: the preview pane shows the finished landing page over a galaxy background."
  width={960}
  height={594}
  caption="A background image, Google Fonts, a color palette pulled from the photo, and text shadows for readability."
...
<Screenshot
  ...
  alt="Learn HTML and CSS, solo project brief: the finished Hometown Homepage site with a hero photo and three activity columns."
  width={521}
  height={631}
  narrow
