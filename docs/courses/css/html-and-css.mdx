...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 2:04 of the flexbox lesson, display: flex and justify-content: center are set; margin-left and margin-right fix what Per calls 'totally crammed into each other' a few seconds later."
/>
