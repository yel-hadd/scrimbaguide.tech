...
Scrimba's biggest CSS course, taught by Kevin Powell across about 15 hours and six modules, building four sites from a phone-width layout up to desktop. I opened every module and read the transcripts of 62 of its 174 scrims, at least a third of every module, with a Pro account in September 2026. This is what is actually in there, including the parts that have aged.
...
Learn Responsive Web Design is a Pro, intermediate CSS course: 15.1 hours of video, 175 lessons in six modules, taught by Kevin Powell. It starts with a box model refresher and ends with a three-page company site that has a slide-out mobile menu. In between you build a blog with three pages, a barbecue landing page with a form, and a card component, all mobile first. The teaching is talk-along coding with a "pause and try this yourself" prompt every few minutes rather than graded challenges. It is the course to take if you can already write some CSS and want layout to stop feeling like guesswork. It is not a first course, and parts of it were recorded years ago, so a few details (Adobe XD design files, a Chrome bug workaround, one stale promo) show their age.
...
<div className="screenshot-grid">
  <Screenshot
    ...
    width={1279}
    height={720}
    caption="Module 2: the mindset shift the course is named after."
    source=""
  />
  <Screenshot
  ...
  <Screenshot
    ...
    width={1279}
    height={720}
    caption="Module 6: the final three-page site."
...
<Screenshot
  ...
  alt="Scrimba Learn Responsive Web Design lesson The problem with ems, paused with the preview window open over the editor: a page titled The CSS Unit em shows a bulleted list whose items render far larger than the heading above them because nested em font sizes multiply"
  width={1400}
  height={560}
  caption="The problem with ems, paused at 1:33. The body is 10px, the section is 2em, the list is 1.5em and the items are 1.5em again, so the list items end up bigger than the heading. Kevin's conclusion two minutes later: use rem for font size, em for padding and margin."
/>
...
<Screenshot
  ...
  alt="Scrimba Learn Responsive Web Design lesson auto-fit and auto-fill, paused with the preview open over the editor: a dark page titled Some of my work shows six white project cards laid out four across and two below by a repeat auto-fill grid"
  width={1400}
  height={590}
  caption="auto-fit and auto-fill, paused at 1:58. One line, grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)), and the cards reflow from one column to four as the preview widens. His words at that moment: 'I don't have a media query in here. It's just magically working.'"
/>
...
<Screenshot
  ...
  alt="Scrimba Learn Responsive Web Design lesson on the small-screen navigation, paused with the preview open over the editor: a black full-screen menu with a magenta debug border shows three centered links reading home, about us and contact"
  width={1400}
  height={590}
  caption="Setting up our navigation for small screens with positioning, paused at 5:18. The nav is position: fixed with top, right, bottom and left at 0, and the magenta border is a debugging aid he removes later. The next scrim adds the JavaScript that opens and closes it."
/>
