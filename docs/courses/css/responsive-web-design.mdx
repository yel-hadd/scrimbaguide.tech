...
This course is not part of the [Frontend Developer Path](/docs/paths/frontend-developer-path/) or the [Fullstack Developer Path](/docs/paths/fullstack-developer-path/); both teach responsive design through their own modules instead. It stands on its own as the longest CSS course in Scrimba's catalog. Modules 4 and 5 cover the same ground as the standalone flexbox and grid courses in more depth, so once you have finished this you can treat those as optional refreshers. [Learn Tailwind CSS](/docs/courses/css/tailwind-css/) makes more sense after this, not instead of it, because Tailwind's utilities map onto exactly the properties you learn here.
