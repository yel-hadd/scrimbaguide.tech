...
<Screenshot
  ...
  width={1280}
  height={720}
  caption="This module declares a variable on :root, scopes one to a class, then scopes another inside a single selector."
...
<Screenshot
  ...
  alt="Learn CSS Variables, intro slide: a diagram showing how to declare a variable on :root and reference it with var()."
  width={1280}
  height={720}
...
<Screenshot
  ...
  alt="Learn CSS Variables, intro scrim: a code editor beside a portfolio preview with a nav, heading and four project cards."
  width={1400}
  height={737}
