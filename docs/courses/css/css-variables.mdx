...
This course is not part of any Scrimba career path. It is a half hour top-up, not a milestone. The natural neighbours are [Learn CSS Grid](/docs/courses/css/css-grid/) and [Learn Flexbox](/docs/courses/css/flexbox/) for layout, and [Learn Responsive Web Design](/docs/courses/css/responsive-web-design/) for the media query side. If you come here from [Learn Tailwind CSS](/docs/courses/css/tailwind-css/), this is what Tailwind's theme tokens compile down to.
