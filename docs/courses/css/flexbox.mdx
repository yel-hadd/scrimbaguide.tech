...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Justify Content at 1:49. All six values sit in a comment under the rule, and Per has just asked you to swap in space-between and space-evenly yourself."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 2:26 of Align items, align-items: center and justify-content: center are the two lines doing the work, a trick Per says comes in handy often."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="'Flex grow, shrink, basis' at 7:50, the challenge brief: make Logout grow ten times faster than Home once the container passes 400px, by changing just one number."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="This is the closest thing to a project in the course, and at 4:58 of Bonus: Responsive Navbar, order: 1 has just moved Search to the bottom of the stack."
/>
