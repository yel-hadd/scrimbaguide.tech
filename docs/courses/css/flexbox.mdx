...
<Screenshot
  ...
  alt="Learn Flexbox, Justify Content lesson: the preview shows navbar links spaced evenly across a yellow bar."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn Flexbox, Align items lesson: the preview shows a close button centred inside a bordered box."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn Flexbox, Flex grow, shrink, basis challenge: the preview shows a two-item navbar sharing space evenly."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn Flexbox, Responsive Navbar bonus lesson: the preview shows the navbar links stacked vertically for mobile."
  width={1400}
  height={660}
