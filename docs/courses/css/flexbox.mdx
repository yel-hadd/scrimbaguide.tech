...
This is a focused skill course, standalone rather than attached to a Scrimba career path. It pairs with [Learn CSS Grid](/docs/courses/css/css-grid/): Flexbox for rows and columns of items, Grid for two-dimensional layouts. Both become optional once you take [Learn Responsive Web Design](/docs/courses/css/responsive-web-design/), which folds them in.
