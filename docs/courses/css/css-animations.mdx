...
This course is not part of any Scrimba career path. The natural order is [Learn HTML and CSS](/docs/courses/css/html-and-css/), then this, then [Responsive Web Design](/docs/courses/css/responsive-web-design/), which the closing video itself recommends and which revisits transitions and animations inside real layouts. The CSS variables lesson overlaps with the free [CSS Variables](/docs/courses/css/css-variables/) course, and the challenge format is a good warm-up for [CSS Challenges](/docs/courses/css/css-challenges/).
