...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="Defining Animations at 5:32. The three-step keyframes block is the whole lesson, and the preview stays collapsed to a thumbnail, how Jad works for most of the course."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 4:44 of Custom Timing Functions, right after the cubic-bezier curve swaps in for ease-out, the preview fills the frame instead of shrinking to its usual thumbnail elsewhere in the course."
/>
