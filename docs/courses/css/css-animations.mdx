...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="A tour of the course plan and one practical warning: the preview keeps animating in real time even when the video is paused."
  source=""
/>
...
<Screenshot
  ...
  alt="Learn CSS Animations, Defining Animations lesson: a keyframes rule sits in the editor beside a small preview thumbnail."
  width={1400}
  height={660}
...
<Screenshot
  ...
  alt="Learn CSS Animations, Real-World Transforms Challenge: the preview thumbnail shows a finished logo made of skewed color bars."
  width={1400}
  height={660}
...
<Screenshot
  ...
  width={1279}
  height={720}
  caption="Three unrelated tips: outdated browser prefixes, CSS custom properties, and cubic-bezier timing curves you shape yourself."
...
<Screenshot
  ...
  alt="Learn CSS Animations, Custom Timing Functions lesson: an enlarged preview window shows a box mid-animation over a blurred editor."
  width={1400}
  height={660}
