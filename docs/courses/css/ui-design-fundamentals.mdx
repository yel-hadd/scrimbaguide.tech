...
<Provenance subject="course" date={frontMatter.reviewed} detail="every transcript, and a sample of the lessons stepped through firsthand" />

*This page is part of our [Scrimba CSS courses](/docs/courses/css/) catalog. It is also one of the free courses inside the [Frontend Developer Path](/docs/paths/frontend-developer-path/) and the [Fullstack Developer Path](/docs/paths/fullstack-developer-path/), and the taster for the Pro-only [Learn UI Design](/docs/courses/css/ui-design/).*
...
<Screenshot
  ...
  width={1278}
  height={719}
  caption="Three scrims frame the fundamentals as one part of a larger module, cover non-dev design roles, and set the audience as developers who already know basic HTML and CSS."
  source=""
/>
...
<Screenshot
  ...
  alt="Slide from Scrimba's Intro to UI Design Fundamentals course: white space is the empty space between interface elements."
  width={1278}
  height={719}
  caption="White Space and Alignment fix two identical cards with padding, margin and line-height, then Design Challenge 1 asks you to do the same to a card of your own."
  source=""
/>
...
<Screenshot
  ...
  width={1400}
  height={635}
  caption="The Overwrite CSS comment holds the only three rules that differ between these otherwise identical cards, 4:37 into White Space; Gary settled on 1.9em of padding after trying 1em and 1.5em on screen."
/>
...
<Screenshot
  ...
  width={1400}
  height={635}
  caption="The same cards at 6:33 after his solution: the card stays low contrast against the page, since Gary argues containers do not need much, while the title carries the high contrast instead."
/>
...
<Screenshot
  ...
  alt="Slide from Scrimba's Intro to UI Design Fundamentals course: every element on an interface has a level of importance."
  width={1278}
  height={719}
  caption="The longest lesson combines white space, contrast, color and scale to make one element on a mailing list form stand out, then Design Challenge 4 applies the same idea to a card."
...
It fits developers who can build a layout but cannot say why it looks off. It also fits students partway through [Learn HTML and CSS](/docs/courses/css/html-and-css/) or [Learn Responsive Web Design](/docs/courses/css/responsive-web-design/) who want to stop shipping ugly projects. It also suits anyone weighing whether to pay for [Learn UI Design](/docs/courses/css/ui-design/). [Designers coming from the code side](/docs/for/designers/) will like it too, because the whole course speaks CSS rather than Figma.
...
This course is part of the [Frontend Developer Path](/docs/paths/frontend-developer-path/) and the [Fullstack Developer Path](/docs/paths/fullstack-developer-path/), which is why its first two scrims talk about "this module" and "this path." The natural sequence is [Learn HTML and CSS](/docs/courses/css/html-and-css/), then this, then [Learn UI Design](/docs/courses/css/ui-design/) or [Learn Responsive Web Design](/docs/courses/css/responsive-web-design/). If you are following the [Frontend Developer Path](/docs/paths/frontend-developer-path/), it is a useful hour to slot in before [Learn UI Design](/docs/courses/css/ui-design/).
