...
sidebar_label: "Intro to UI Design Fundamentals"
...
A free, 70 minute Scrimba course in which Gary Simon fixes ugly interfaces with a handful of CSS rules, one design principle at a time. I read the transcript of every scrim, all twenty of them, and stepped through a sample of the lessons with a Pro account in September 2026. This page is what is actually in there.
...
Intro to UI Design Fundamentals is a free, flat course of 20 scrims that Scrimba's header sums to 70 minutes. Gary Simon walks through seven principles: white space, alignment, contrast, scale, typography, color, and visual hierarchy. After every one or two of them you get a "Design Challenge" scrim where the recording pauses and you fix a deliberately bad layout in `index.css`.

There is no Figma, no design tool, and no JavaScript. Every example is a small HTML page with a CSS file and a comment that says where your fixes go. It is rated Intermediate only because it assumes you already write CSS. If you do, and your pages look slightly wrong without you knowing why, this is the quickest fix in the catalog.
...
The honest caveat is in the first lesson Gary appears in. In the Course Introduction he says "this course is actually just a small sample from my upcoming UI design boot camp releasing here on Scrimba." That boot camp is now the 8.6 hour, Pro-only [Learn UI Design](/docs/courses/css/ui-design/), and this course is its free front door.
...
<Screenshot
  ...
  alt="Scrimba Intro to UI Design Fundamentals White Space lesson paused at 4:37: index.css shows .secondary rules with padding 1.9em, an h1 margin-bottom of .5em and a p line-height of 1.5em, and the preview on the right shows two My Title cards, the left one cramped and the right one with even padding and looser line spacing"
  width={1400}
  height={635}
...
<Screenshot
  ...
  alt="Scrimba Intro to UI Design Fundamentals Design Challenge 2 at 0:14: the preview is enlarged over the blurred editor and shows three bright blue November Rain cards with a circle avatar, the date and title touching and no padding around the text"
  width={1400}
  height={635}
...
<Screenshot
  ...
  alt="Scrimba Intro to UI Design Fundamentals Design Challenge 2 at 6:33: the preview shows the same three cards after Gary's solution, dark grey card backgrounds on a near-black page, 1.5em of padding, an uppercase letter-spaced date in muted grey and a large pale blue November Rain title"
  width={1400}
  height={635}
...
<Screenshot
  ...
  alt="Scrimba Intro to UI Design Fundamentals The Final Challenge at 5:21: index.css shows the three completed rule sets, body grid-gap 2em, .content background #0044B9 with padding 1.5em, and h1 margin-left 0 with font-size 2.3em, each annotated with the principle it improves, while the preview shows a blue dashboard with a Sales Report card listing earnings, refunds, chargebacks and net income"
  width={1400}
  height={635}
...
The video is 70 minutes. Budget two to three hours. The five challenges are where the time goes: each one asks you to stop, write CSS, look at the result, and adjust. A reasonable attempt at Design Challenge 2 or the Final Challenge is ten to fifteen minutes on its own.
...
Where it is limited: it is an hour, and it stops at the seven principles. Two of its twenty scrims are not about the course at all, and three more are Scrimba housekeeping. The challenges have no automatic feedback, so how much you learn depends on how honestly you compare your version with his.
...
<FAQAccordion items={[
  ...
  { q: "How long does it take?", a: "70 minutes of video by Scrimba's count, about 77 if you include the three unlisted wrap-up scrims. Plan on two to three hours if you actually do the five challenges." },
