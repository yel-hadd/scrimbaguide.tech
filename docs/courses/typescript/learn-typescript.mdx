...
<Screenshot
  ...
  width={1400}
  height={630}
  caption="9:15 of Intro to Pizza app: this is the JavaScript crash that TypeScript would have caught before you ever ran the code."
/>
...
<Screenshot
  ...
  width={1400}
  height={630}
  caption="Bob's verdict at 0:47 of Move code to TS: 'Nothing about using TypeScript here is introducing new bugs, it's just showing me where the bugs already existed.'"
/>
...
<Screenshot
  ...
  width={1400}
  height={630}
  caption="The Final Challenge's solution, at 0:30, needs a KeyboardProps type with addGuessedLetter typed as (letter: string) => void."
/>
...
<Screenshot
  ...
  width={1400}
  height={630}
  caption="At 2:46 of String query params, the filter is correct JavaScript; Express just types req.query as string | ParsedQs | arrays, so TypeScript fails the build with TS2339."
/>
