...
<Provenance subject="course" date={frontMatter.reviewed} detail="all 38 scrims and transcripts" />
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="At 8:03 of the onValue aside, Rafid edits a book title in the Firebase console and the preview shows four books instead of two, because the loop appends without clearing first."
/>
...
<Screenshot
  ...
  width={1400}
  height={660}
  caption="0:53 into Scrim 21, Rafid deletes the last item and the console fills with a Firebase warning ending in TypeError: Cannot convert undefined or null to object."
/>
