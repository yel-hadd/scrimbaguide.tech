...
Sometimes you must touch the **DOM**, **network**, or **subscriptions**,that is **`useRef`** and **`useEffect`**, plus when **not** to use an effect. This page links to a free scrim and **Advanced React (Pro)** for deeper patterns.
