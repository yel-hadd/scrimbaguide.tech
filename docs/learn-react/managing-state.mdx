...
Local `useState` stops scaling when siblings and deep trees need the same data, here is **lifted state**, **Context**, and **useReducer**, with a path into **Advanced React (Pro)** for full depth.
