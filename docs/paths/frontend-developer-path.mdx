...
- [Intro to UI Design Fundamentals](/docs/courses/css/ui-design-fundamentals/) (Free, 1.2 hrs)
- [Learn Accessible Web Design](/docs/courses/javascript/accessible-web-design/) (Pro, 1.6 hrs)
...
- [Advanced React](/docs/courses/react/advanced-react/) (Pro, 18.8 hrs)
- [JavaScript Interview Challenges](/docs/courses/javascript/javascript-interview-challenges/) (Pro, 2.3 hrs)
- [Frontend Interview Tips](/docs/courses/javascript/frontend-interview-tips/) (Pro, 1.7 hrs)
- [React Interview Questions](/docs/courses/react/react-interview-questions/) (Pro, 41 min)

The path also draws on part of [Advanced JavaScript](/docs/courses/javascript/advanced-javascript/) and [Learn UI Design](/docs/courses/css/ui-design/), not the full courses.
