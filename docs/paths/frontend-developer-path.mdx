...
**Cons**
- Pro-only. No lifetime unlock for the full path. Compare with [Scrimba pricing](/docs/pricing/) and [Pro vs Free](/docs/pricing/pro-vs-free/) before paying, and check the [student discount](/docs/pricing/student-discount/) if you qualify.
