...
<Provenance subject="path" date={frontMatter.reviewed} detail="all 13 modules and 62 groups expanded" />
...
<div className="screenshot-grid">
  ...
  <Screenshot
    ...
    alt="Frontend Developer Path, solo project brief: a finished homepage site with a hero photo and activity columns."
    width={1214}
    height={684}
...
<Screenshot
  ...
  alt="Frontend Developer Path, Getting Hired lesson: a slide listing what hiring managers actually want in a candidate."
  width={1214}
  height={684}
