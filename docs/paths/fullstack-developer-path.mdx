...
For context on the job market, ZipRecruiter places average U.S. back end developer pay around $120k as of May 2026, and the BLS bundles related roles under Software Developers and Web Developers with national medians above $80k ([BLS Software Developers](https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm), [BLS Web Developers](https://www.bls.gov/ooh/computer-and-information-technology/web-developers.htm)). Scrimba Pro costs a fraction of a bootcamp; check the [official pricing page](https://scrimba.com/our-pricing) for today's rate.
