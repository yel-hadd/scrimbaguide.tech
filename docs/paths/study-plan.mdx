...
At **10–15 hrs/week**, Scrimba’s **~81.6h Frontend path** usually lands in **~4–6 months**. Latest BLS wage releases continue to show web/software roles as strong-pay tracks, while Pro is typically **~$200/yr** vs **$10k–$20k+** bootcamps. This page is your **week-by-week map** so “how long?” stops being a vague worry.
...
Open-ended “I’ll study when I can” plans die in week three. Steady **10–15 hours** beats heroic weekends, this roadmap assumes that pace and maps the [Frontend Developer Path](/docs/paths/frontend-developer-path) month by month.
...
<PricingCTA
  ...
  subtitle="Validate scrims on free courses, then use Pro for the full Frontend sequence + Discord."
