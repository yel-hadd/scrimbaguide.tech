...
**Quick answer:** At **10–15 hrs/week**, Scrimba’s **~81.6h Frontend path** usually lands in **~4–6 months**—median web developer pay neared **$72k/yr** (BLS, 2024), while Pro is typically **~$200/yr** vs **$10k–$20k+** bootcamps. This page is your **week-by-week map** so “how long?” stops being a vague worry.
...
**Problem:** Open-ended “I’ll study when I can” plans die in week three. **Solve:** Steady **10–15 hours** beats heroic weekends—this roadmap assumes that pace and maps the [Frontend Developer Path](/docs/paths/frontend-developer-path) month by month.
