...
That difference is not cosmetic. Odin teaches you to read documentation, which is the actual job. Scrimba teaches you the concepts faster but lets you stay in a sandboxed browser longer than is good for you. It does point the way out: [Learn JavaScript](/docs/courses/javascript/learn-javascript/) has a four-scrim local-setup module (GitHub Desktop, VS Code, a push to GitHub) and deploys the first project to Netlify, and Learn HTML and CSS sends you into DevTools on the BBC site and publishes with GitHub Desktop. It just never makes you do it.
