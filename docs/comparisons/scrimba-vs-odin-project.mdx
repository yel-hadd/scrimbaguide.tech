...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: "Community", scrimba: "Pro Discord with instructor presence", competitor: "Open Discord (~90,000+ members), peer-to-peer" },
...
The Trustpilot numbers actually run in Scrimba's favor here: Scrimba sits at 4.3/5, while Odin's public average is around 3.7/5 ([Trustpilot](https://www.trustpilot.com/review/www.theodinproject.com), as of 2026). Read both as rough signals rather than verdicts, since a free, self-directed curriculum draws a different mix of reviewers than a paid platform, and Trustpilot skews toward people motivated enough to post. Both remain widely recommended in their category.
