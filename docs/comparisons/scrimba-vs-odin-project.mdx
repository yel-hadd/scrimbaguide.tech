...
### 1. Paid-interactive or free-open-source? {#1-paid-interactive-or-free-open-source}
...
### 2. Video-led, or text-and-build-it-yourself? {#2-video-led-or-text-and-build-it-yourself}
...
### 3. Curated path, or full autonomy? {#3-curated-path-or-full-autonomy}
...
## Where Odin clearly wins {#where-odin-clearly-wins}
...
## Communities, briefly {#communities-briefly}
