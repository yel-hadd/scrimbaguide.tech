...
## The three decisions you are actually making {#the-three-decisions-you-are-actually-making}
...
## Tutorial hell, named {#tutorial-hell-named}
...
## Format head-to-head: Net Ninja React vs Bob Ziroll React {#format-head-to-head-net-ninja-react-vs-bob-ziroll-react}

Two of the most-watched React courses are free. Both are taught by experienced instructors. They are not the same product.

### Net Ninja's Full Modern React Tutorial {#net-ninjas-full-modern-react-tutorial}
...
### Bob Ziroll's Learn React on Scrimba {#bob-zirolls-learn-react-on-scrimba}
...
## Where YouTube clearly wins {#where-youtube-clearly-wins}
...
## Combine them properly {#combine-them-properly}
...
## Pick by how you study tomorrow {#pick-by-how-you-study-tomorrow}
