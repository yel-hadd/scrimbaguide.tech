...
### 1. Established library vs current curriculum {#1-established-library-vs-current-curriculum}
...
### 2. Video-first vs interactive video {#2-video-first-vs-interactive-video}
...
### 3. Tracks vs paths (and the Techdegree question) {#3-tracks-vs-paths-and-the-techdegree-question}
...
## Where Treehouse clearly wins {#where-treehouse-clearly-wins}
...
## When Scrimba clearly wins {#when-scrimba-clearly-wins}
...
## Choose Scrimba vs Treehouse {#choose-scrimba-vs-treehouse}
