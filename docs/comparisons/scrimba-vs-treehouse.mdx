...
<VerdictBox
  ...
  pros={[
    ...
    `Scrimba: Around ${freeCount} free full courses; Treehouse offers only a trial`,
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: "Entry-level monthly price", scrimba: "Check current pricing", competitor: "~$25/mo (Courses) after 7-day trial" },
    { feature: "Top tier monthly price", scrimba: "Pro (annual is best value)", competitor: "~$199/mo (Techdegree)" },
    { feature: "Platform age and update cadence", scrimba: "Launched 2017, current with 2026 stack", competitor: "Launched 2011, slower curriculum refresh" },
...
<DocFaqSchema questions={[
  ...
  { q: "How much does Treehouse cost in 2026?", a: "The Courses subscription starts around $25/month after a 7-day trial, and the Techdegree program is around $199/month. Treehouse has simplified its plan structure over time, so check the live pricing page for any middle tier currently on offer." },
...
<FAQAccordion emitSchema={false} items={[
  ...
  { q: "How much does Treehouse cost in 2026?", a: "Courses subscription around $25/mo after a 7-day trial, Techdegree around $199/mo. Verify any middle tier on the live pricing page." },
