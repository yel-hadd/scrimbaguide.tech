...
## Decide in one minute {#decide-in-one-minute}
...
## What Frontend Masters actually is {#what-frontend-masters-actually-is}
...
## Where Frontend Masters clearly wins {#where-frontend-masters-clearly-wins}
...
## When to choose Scrimba {#when-to-choose-scrimba}
...
## When to choose Frontend Masters {#when-to-choose-frontend-masters}
