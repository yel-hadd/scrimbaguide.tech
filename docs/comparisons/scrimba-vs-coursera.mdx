...
### 1. Accredited credential vs skills you can demo on a call {#1-accredited-credential-vs-skills-you-can-demo-on-a-call}
...
### 2. University-led video vs platform-led scrims {#2-university-led-video-vs-platform-led-scrims}
...
### 3. Breadth (data science, ML, business) vs web-and-AI focus {#3-breadth-data-science-ml-business-vs-web-and-ai-focus}
...
## Where Coursera clearly wins {#where-coursera-clearly-wins}
...
## An honest note: Scrimba is also on Coursera {#an-honest-note-scrimba-is-also-on-coursera}
...
## Choose Scrimba vs Coursera {#choose-scrimba-vs-coursera}
