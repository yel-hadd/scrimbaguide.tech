...
<VerdictBox
  ...
  verdict="If you are buying a credential to clear an HR filter or stack ACE-recommended college credit, Coursera wins. If you are buying daily coding reps to ship a portfolio in 90 days, Scrimba's scrim format wins. Most self-taught web developers do better starting with Scrimba and adding a targeted Coursera professional certificate only when a specific job posting demands it."
  pros={[
