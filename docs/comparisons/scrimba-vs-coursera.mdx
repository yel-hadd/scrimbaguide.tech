...
<DocFaqSchema questions={[
  { q: "Is Scrimba on Coursera?", a: "Yes. Scrimba publishes around 11 specializations on Coursera. The full interactive scrim experience, where you edit the instructor's code in the video player, is only available on Scrimba's own platform." },
