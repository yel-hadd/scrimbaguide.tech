...
3. **You want to interview at companies that ask algorithm questions.** Boot.dev's CS fundamentals (data structures, Big-O, recursion, trees, graphs) directly map to LeetCode-style screens. Scrimba has one 2.5-hour [Data Structures and Algorithms](/docs/courses/javascript/data-structures-and-algorithms/) course (Big O, linked lists, trees, graphs, eleven challenges with Vitest test files, Pro after the first four scrims). It is a primer, not a track.
