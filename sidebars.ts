...
const sidebars: SidebarsConfig = {
  docs: [
    // 1. Start Here. Every doc sets a short sidebar_label (CLAUDE.md, Sidebar
    // labels); category labels here match the navbar ("Paths", "Courses").
    'intro',
    // 2. How Scrimba Works
    {
      type: 'category',
    ...
    // 10. FAQ (curated hub linking to the distributed answers)
    'faq/index',
    // 11. Help
    {
      type: 'category',
